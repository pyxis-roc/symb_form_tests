...
@.str = private constant [55 x i8] c"Assert fail: num_args == 2, cast: num_args should be 2\00", align 1
@.str.1 = private constant [13 x i8] c"RuntimeError\00", align 1
@.str.2 = private constant [63 x i8] c"Assert fail: not T.isnullptr(args), cast: args pointer is NULL\00", align 1
@.str.3 = private constant [146 x i8] c"Assert fail: var_A_type_index == 0 or var_A_type_index == 4 or var_A_type_index == 7 or var_A_type_index >= 64, cast: Expect arg[0] to be pointer\00", align 1
@.str.4 = private constant [170 x i8] c"Assert fail: var_compute_type_index == 0 or var_compute_type_index == 4 or var_compute_type_index == 7 or var_compute_type_index >= 64, cast: Expect arg[1] to be pointer\00", align 1
@.str.5 = private constant [95 x i8] c"Assert fail: not T.isnullptr(var_A), cast.var_A is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.6 = private constant [97 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_A, 0, 4, \22int32\22), cast.var_A.ndim is expected to equal 2\00", align 1
@.str.7 = private constant [107 x i8] c"Assert fail: not T.isnullptr(var_compute), cast.var_compute is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.8 = private constant [109 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_compute, 0, 4, \22int32\22), cast.var_compute.ndim is expected to equal 2\00", align 1
@.str.9 = private constant [227 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_A, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_A, 0, 7, \22uint16\22) == T.uint16(1), cast.var_A.dtype is expected to be float32\00", align 1
@.str.10 = private constant [179 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, cast_var_A_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, cast_var_A_strides[0])), cast.var_A.strides: expected to be compact array\00", align 1
@.str.11 = private constant [187 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22), Argument cast.var_A.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22)\00", align 1
@.str.12 = private constant [167 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 10, \22int32\22) == 1, Argument cast.var_A.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_A, 0, 10, \22int32\22)\00", align 1
@.str.13 = private constant [100 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(A), cast.var_A is expected to have non-NULL data pointer\00", align 1
@.str.14 = private constant [249 x i8] c"Assert fail: T.tvm_struct_get(var_compute, 0, 5, \22uint8\22) == T.uint8(0) and T.tvm_struct_get(var_compute, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_compute, 0, 7, \22uint16\22) == T.uint16(1), cast.var_compute.dtype is expected to be int32\00", align 1
@.str.15 = private constant [176 x i8] c"Assert fail: M == T.Cast(\22int32\22, cast_var_compute_shape[0]), Argument cast.var_compute.shape[0] has an unsatisfied constraint: M == T.Cast(\22int32\22, cast_var_compute_shape[0])\00", align 1
@.str.16 = private constant [176 x i8] c"Assert fail: N == T.Cast(\22int32\22, cast_var_compute_shape[1]), Argument cast.var_compute.shape[1] has an unsatisfied constraint: N == T.Cast(\22int32\22, cast_var_compute_shape[1])\00", align 1
@.str.17 = private constant [197 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, cast_var_compute_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, cast_var_compute_strides[0])), cast.var_compute.strides: expected to be compact array\00", align 1
@.str.18 = private constant [205 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_compute, 0, 8, \22uint64\22), Argument cast.var_compute.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_compute, 0, 8, \22uint64\22)\00", align 1
@.str.19 = private constant [185 x i8] c"Assert fail: T.tvm_struct_get(var_compute, 0, 10, \22int32\22) == 1, Argument cast.var_compute.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_compute, 0, 10, \22int32\22)\00", align 1
@.str.20 = private constant [191 x i8] c"Assert fail: dev_id == T.tvm_struct_get(var_compute, 0, 9, \22int32\22), Argument cast.var_compute.device_id has an unsatisfied constraint: dev_id == T.tvm_struct_get(var_compute, 0, 9, \22int32\22)\00", align 1
@.str.21 = private constant [112 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(compute), cast.var_compute is expected to have non-NULL data pointer\00", align 1
@__tvm_main__ = weak dllexport local_unnamed_addr constant [5 x i8] c"cast\00", align 1
@llvm.global_ctors = appending global [0 x { i32, ptr, ptr }] zeroinitializer

define dllexport range(i32 -1, 1) i32 @cast(ptr noalias nocapture readnone %self_handle, ptr noalias readonly %args, i32 %num_args, ptr noalias nocapture readnone %result) local_unnamed_addr #0 !dbg !5 {
entry:
...
assert_end4:                                      ; preds = %switch.early.test, %switch.early.test, %switch.early.test, %assert_end2
  ...
  %var_compute.type_index = load i32, ptr %5, align 4, !dbg !15
    #dbg_declare(i32 %var_compute.type_index, !22, !DIExpression(), !15)
    #dbg_declare(i32 %var_compute.type_index, !22, !DIExpression(), !15)
  %var_compute.type_index.fr = freeze i32 %var_compute.type_index, !dbg !15
  %6 = icmp sgt i32 %var_compute.type_index.fr, 63, !dbg !15
  br i1 %6, label %assert_end6, label %switch.early.test43, !dbg !15

switch.early.test43:                              ; preds = %assert_end4
  switch i32 %var_compute.type_index.fr, label %assert_fail5 [
...
assert_end6:                                      ; preds = %switch.early.test43, %switch.early.test43, %switch.early.test43, %assert_end4
  ...
  %13 = icmp eq i32 %var_compute.type_index.fr, 72, !dbg !15
  %var_compute.idx = select i1 %13, i64 16, i64 0, !dbg !15
  %var_compute = getelementptr inbounds nuw i8, ptr %12, i64 %var_compute.idx, !dbg !15
    #dbg_declare(ptr %var_compute, !24, !DIExpression(), !15)
    #dbg_declare(ptr %var_compute, !24, !DIExpression(), !15)
...
assert_end10:                                     ; preds = %assert_end8
  ...
  %cast.var_A.shape = load ptr, ptr %19, align 8, !dbg !15
    #dbg_declare(ptr %cast.var_A.shape, !25, !DIExpression(), !15)
    #dbg_declare(ptr %cast.var_A.shape, !25, !DIExpression(), !15)
  %20 = load i64, ptr %cast.var_A.shape, align 8, !dbg !15, !tbaa !28
  %M = trunc i64 %20 to i32, !dbg !15
    #dbg_declare(i32 %M, !38, !DIExpression(), !15)
    #dbg_declare(i32 %M, !38, !DIExpression(), !15)
  %21 = getelementptr inbounds nuw i8, ptr %cast.var_A.shape, i64 8, !dbg !15
  ...
  %cast.var_A.strides = load ptr, ptr %23, align 8, !dbg !15
    #dbg_declare(ptr %cast.var_A.strides, !42, !DIExpression(), !15)
    #dbg_declare(ptr %cast.var_A.strides, !42, !DIExpression(), !15)
...
assert_end12:                                     ; preds = %assert_end10
  %26 = getelementptr inbounds nuw i8, ptr %var_compute, i64 16, !dbg !15
...
assert_end14:                                     ; preds = %assert_end12
  %30 = getelementptr inbounds nuw i8, ptr %var_compute, i64 24, !dbg !15
  %cast.var_compute.shape = load ptr, ptr %30, align 8, !dbg !15
    #dbg_declare(ptr %cast.var_compute.shape, !47, !DIExpression(), !15)
    #dbg_declare(ptr %cast.var_compute.shape, !47, !DIExpression(), !15)
  %31 = getelementptr inbounds nuw i8, ptr %var_compute, i64 32, !dbg !15
  %cast.var_compute.strides = load ptr, ptr %31, align 8, !dbg !15
    #dbg_declare(ptr %cast.var_compute.strides, !48, !DIExpression(), !15)
    #dbg_declare(ptr %cast.var_compute.strides, !48, !DIExpression(), !15)
  %compute = load ptr, ptr %var_compute, align 8, !dbg !15
    #dbg_declare(ptr %compute, !49, !DIExpression(), !15)
    #dbg_declare(ptr %compute, !49, !DIExpression(), !15)
  call void @llvm.assume(i1 true) [ "align"(ptr %compute, i64 64) ], !dbg !15
...
assert_end16:                                     ; preds = %assert_end14
  %.not46 = icmp eq ptr %cast.var_A.strides, null, !dbg !15
  br i1 %.not46, label %if_end, label %if_then, !dbg !15, !prof !20

if_then:                                          ; preds = %assert_end16
  %44 = load i64, ptr %cast.var_A.strides, align 8, !dbg !15, !tbaa !51
  %45 = trunc i64 %44 to i32, !dbg !15
  %46 = icmp eq i32 %N, %45, !dbg !15
  %47 = icmp eq i32 %M, 1, !dbg !15
  %48 = or i1 %47, %46, !dbg !15
  %49 = getelementptr inbounds nuw i8, ptr %cast.var_A.strides, i64 8, !dbg !15
  %50 = load i64, ptr %49, align 8, !dbg !15, !tbaa !61
...
assert_end24:                                     ; preds = %assert_end22
  %70 = getelementptr inbounds nuw i8, ptr %var_compute, i64 22, !dbg !15
  %71 = load i16, ptr %70, align 2, !dbg !15
  %72 = icmp eq i16 %71, 1, !dbg !15
  %73 = getelementptr inbounds nuw i8, ptr %var_compute, i64 21, !dbg !15
  %74 = load i8, ptr %73, align 1, !dbg !15
  %75 = icmp eq i8 %74, 32, !dbg !15
  %76 = getelementptr inbounds nuw i8, ptr %var_compute, i64 20, !dbg !15
  %77 = load i8, ptr %76, align 1, !dbg !15
  %78 = icmp eq i8 %77, 0, !dbg !15
...
assert_end26:                                     ; preds = %assert_end24
  %82 = load i64, ptr %cast.var_compute.shape, align 8, !dbg !15, !tbaa !63
...
assert_end28:                                     ; preds = %assert_end26
  %86 = getelementptr inbounds nuw i8, ptr %cast.var_compute.shape, i64 8, !dbg !15
  %87 = load i64, ptr %86, align 8, !dbg !15, !tbaa !73
...
assert_end30:                                     ; preds = %assert_end28
  %.not47 = icmp eq ptr %cast.var_compute.strides, null, !dbg !15
  br i1 %.not47, label %if_end32, label %if_then31, !dbg !15, !prof !20

if_then31:                                        ; preds = %assert_end30
  %91 = load i64, ptr %cast.var_compute.strides, align 8, !dbg !15, !tbaa !75
  %92 = trunc i64 %91 to i32, !dbg !15
  %93 = icmp eq i32 %N, %92, !dbg !15
  %94 = icmp eq i32 %M, 1, !dbg !15
  %95 = or i1 %94, %93, !dbg !15
  %96 = getelementptr inbounds nuw i8, ptr %cast.var_compute.strides, i64 8, !dbg !15
  %97 = load i64, ptr %96, align 8, !dbg !15, !tbaa !85
...
if_end32:                                         ; preds = %if_then31, %assert_end30
  %103 = getelementptr inbounds nuw i8, ptr %var_compute, i64 40, !dbg !15
...
assert_end36:                                     ; preds = %if_end32
  %108 = getelementptr inbounds nuw i8, ptr %var_compute, i64 8, !dbg !15
...
assert_end38:                                     ; preds = %assert_end36
  %112 = getelementptr inbounds nuw i8, ptr %var_compute, i64 12, !dbg !15
...
assert_end40:                                     ; preds = %assert_end38
  %116 = icmp ne ptr %compute, null, !dbg !15
...
assert_end42:                                     ; preds = %assert_end40
  tail call fastcc void @cast_compute_(i32 %M, i32 %N, ptr %compute, ptr %A), !dbg !15
  br label %common.ret, !dbg !15
}
...
define internal fastcc void @cast_compute_(i32 %M, i32 %N, ptr noalias nocapture writeonly align 64 %compute, ptr noalias nocapture readonly align 64 %A) unnamed_addr #2 !dbg !87 {
entry:
    #dbg_value(i32 %M, !91, !DIExpression(), !95)
    #dbg_value(i32 %N, !92, !DIExpression(), !95)
    #dbg_value(ptr %compute, !93, !DIExpression(), !95)
    #dbg_value(ptr %A, !94, !DIExpression(), !95)
    #dbg_declare(i32 0, !96, !DIExpression(), !95)
  %0 = icmp sgt i32 %M, 0, !dbg !95
  %1 = icmp sgt i32 %N, 0
  %or.cond = select i1 %0, i1 %1, i1 false, !dbg !95
  br i1 %or.cond, label %for_begin_i1.preheader.us.preheader, label %for_end_i0, !dbg !95, !prof !97

for_begin_i1.preheader.us.preheader:              ; preds = %entry
  %2 = zext nneg i32 %N to i64, !dbg !95
  %wide.trip.count8 = zext nneg i32 %M to i64, !dbg !95
...
for_begin_i1.preheader.us:                        ; preds = %for_begin_i1.preheader.us.preheader, %for_begin_i1.for_end_i1_crit_edge.us
  %indvars.iv5 = phi i64 [ 0, %for_begin_i1.preheader.us.preheader ], [ %indvars.iv.next6, %for_begin_i1.for_end_i1_crit_edge.us ]
    #dbg_declare(i64 %indvars.iv5, !96, !DIExpression(), !95)
    #dbg_declare(i32 0, !98, !DIExpression(), !95)
  %3 = mul nuw nsw i64 %indvars.iv5, %2
  br i1 %min.iters.check, label %for_body_i1.us.preheader, label %vector.body, !dbg !95, !prof !99

vector.body:                                      ; preds = %for_begin_i1.preheader.us, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %for_begin_i1.preheader.us ], !dbg !95
  %4 = add nuw nsw i64 %index, %3, !dbg !95
  %5 = getelementptr inbounds nuw float, ptr %A, i64 %4, !dbg !95
  %6 = getelementptr inbounds nuw i8, ptr %5, i64 16, !dbg !95
  %wide.load = load <4 x float>, ptr %5, align 4, !dbg !95, !tbaa !100
  %wide.load1 = load <4 x float>, ptr %6, align 4, !dbg !95, !tbaa !100
  %7 = fptosi <4 x float> %wide.load to <4 x i32>, !dbg !95
  %8 = fptosi <4 x float> %wide.load1 to <4 x i32>, !dbg !95
  %9 = getelementptr inbounds nuw i32, ptr %compute, i64 %4, !dbg !95
  %10 = getelementptr inbounds nuw i8, ptr %9, i64 16, !dbg !95
  store <4 x i32> %7, ptr %9, align 4, !dbg !95, !tbaa !102
  store <4 x i32> %8, ptr %10, align 4, !dbg !95, !tbaa !102
  %index.next = add nuw i64 %index, 8, !dbg !95
  %11 = icmp eq i64 %index.next, %n.vec, !dbg !95
  br i1 %11, label %middle.block, label %vector.body, !dbg !95, !prof !104, !llvm.loop !105

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %for_begin_i1.for_end_i1_crit_edge.us, label %for_body_i1.us.preheader, !dbg !95, !prof !108

for_body_i1.us.preheader:                         ; preds = %for_begin_i1.preheader.us, %middle.block
  %indvars.iv.ph = phi i64 [ 0, %for_begin_i1.preheader.us ], [ %n.vec, %middle.block ]
  br label %for_body_i1.us, !dbg !95

for_body_i1.us:                                   ; preds = %for_body_i1.us.preheader, %for_body_i1.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %for_body_i1.us ], [ %indvars.iv.ph, %for_body_i1.us.preheader ]
    #dbg_declare(i64 %indvars.iv, !98, !DIExpression(), !95)
  %12 = add nuw nsw i64 %indvars.iv, %3, !dbg !95
  %13 = getelementptr inbounds nuw float, ptr %A, i64 %12, !dbg !95
  %14 = load float, ptr %13, align 4, !dbg !95, !tbaa !100
  %15 = fptosi float %14 to i32, !dbg !95
  %16 = getelementptr inbounds nuw i32, ptr %compute, i64 %12, !dbg !95
  store i32 %15, ptr %16, align 4, !dbg !95, !tbaa !102
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !95
    #dbg_declare(i64 %indvars.iv.next, !98, !DIExpression(), !95)
  %exitcond.not = icmp eq i64 %indvars.iv.next, %2, !dbg !95
  br i1 %exitcond.not, label %for_begin_i1.for_end_i1_crit_edge.us, label %for_body_i1.us, !dbg !95, !prof !109, !llvm.loop !110

for_begin_i1.for_end_i1_crit_edge.us:             ; preds = %for_body_i1.us, %middle.block
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1, !dbg !95
    #dbg_declare(i64 %indvars.iv.next6, !96, !DIExpression(), !95)
  %exitcond9.not = icmp eq i64 %indvars.iv.next6, %wide.trip.count8, !dbg !95
  br i1 %exitcond9.not, label %for_end_i0, label %for_begin_i1.preheader.us, !dbg !95, !prof !111

for_end_i0:                                       ; preds = %for_begin_i1.for_end_i1_crit_edge.us, %entry
  ret void, !dbg !95
}
...
!5 = distinct !DISubprogram(name: "cast", scope: !1, file: !1, type: !6, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !10)
...
!22 = !DILocalVariable(name: "var_compute.type_index", scope: !5, file: !1, type: !8)
!23 = !DILocalVariable(name: "var_A", scope: !5, file: !1, type: !9)
!24 = !DILocalVariable(name: "var_compute", scope: !5, file: !1, type: !9)
!25 = !DILocalVariable(name: "cast.var_A.shape", scope: !5, file: !1, type: !26)
!26 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !27)
!27 = !DIBasicType(name: "int64", size: 64, encoding: DW_ATE_signed)
!28 = !{!29, !29, i64 0}
!29 = !{!"0x5af4dbd24260.w8.b0", !30, i64 0}
!30 = !{!"0x5af4dbd24260.w16.b0", !31, i64 0}
!31 = !{!"0x5af4dbd24260.w32.b0", !32, i64 0}
!32 = !{!"0x5af4dbd24260.w64.b0", !33, i64 0}
!33 = !{!"0x5af4dbd24260.w128.b0", !34, i64 0}
!34 = !{!"0x5af4dbd24260.w256.b0", !35, i64 0}
!35 = !{!"0x5af4dbd24260.w512.b0", !36, i64 0}
!36 = !{!"0x5af4dbd24260.w1024.b0", !37, i64 0}
!37 = !{!"0x5af4dbd24260", !19, i64 0}
!38 = !DILocalVariable(name: "M", scope: !5, file: !1, type: !8)
!39 = !{!40, !40, i64 0}
!40 = !{!"0x5af4dbd24260.w8.b8", !30, i64 0}
!41 = !DILocalVariable(name: "N", scope: !5, file: !1, type: !8)
!42 = !DILocalVariable(name: "cast.var_A.strides", scope: !5, file: !1, type: !26)
...
!47 = !DILocalVariable(name: "cast.var_compute.shape", scope: !5, file: !1, type: !26)
!48 = !DILocalVariable(name: "cast.var_compute.strides", scope: !5, file: !1, type: !26)
!49 = !DILocalVariable(name: "compute", scope: !5, file: !1, type: !50)
!50 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !8)
!51 = !{!52, !52, i64 0}
!52 = !{!"0x5af4dbd37550.w8.b0", !53, i64 0}
!53 = !{!"0x5af4dbd37550.w16.b0", !54, i64 0}
!54 = !{!"0x5af4dbd37550.w32.b0", !55, i64 0}
!55 = !{!"0x5af4dbd37550.w64.b0", !56, i64 0}
!56 = !{!"0x5af4dbd37550.w128.b0", !57, i64 0}
!57 = !{!"0x5af4dbd37550.w256.b0", !58, i64 0}
!58 = !{!"0x5af4dbd37550.w512.b0", !59, i64 0}
!59 = !{!"0x5af4dbd37550.w1024.b0", !60, i64 0}
!60 = !{!"0x5af4dbd37550", !19, i64 0}
!61 = !{!62, !62, i64 0}
!62 = !{!"0x5af4dbd37550.w8.b8", !53, i64 0}
!63 = !{!64, !64, i64 0}
!64 = !{!"0x5af4dbd4d9f0.w8.b0", !65, i64 0}
!65 = !{!"0x5af4dbd4d9f0.w16.b0", !66, i64 0}
!66 = !{!"0x5af4dbd4d9f0.w32.b0", !67, i64 0}
!67 = !{!"0x5af4dbd4d9f0.w64.b0", !68, i64 0}
!68 = !{!"0x5af4dbd4d9f0.w128.b0", !69, i64 0}
!69 = !{!"0x5af4dbd4d9f0.w256.b0", !70, i64 0}
!70 = !{!"0x5af4dbd4d9f0.w512.b0", !71, i64 0}
!71 = !{!"0x5af4dbd4d9f0.w1024.b0", !72, i64 0}
!72 = !{!"0x5af4dbd4d9f0", !19, i64 0}
!73 = !{!74, !74, i64 0}
!74 = !{!"0x5af4dbd4d9f0.w8.b8", !65, i64 0}
!75 = !{!76, !76, i64 0}
!76 = !{!"0x5af4dbd80450.w8.b0", !77, i64 0}
!77 = !{!"0x5af4dbd80450.w16.b0", !78, i64 0}
!78 = !{!"0x5af4dbd80450.w32.b0", !79, i64 0}
!79 = !{!"0x5af4dbd80450.w64.b0", !80, i64 0}
!80 = !{!"0x5af4dbd80450.w128.b0", !81, i64 0}
!81 = !{!"0x5af4dbd80450.w256.b0", !82, i64 0}
!82 = !{!"0x5af4dbd80450.w512.b0", !83, i64 0}
!83 = !{!"0x5af4dbd80450.w1024.b0", !84, i64 0}
!84 = !{!"0x5af4dbd80450", !19, i64 0}
!85 = !{!86, !86, i64 0}
!86 = !{!"0x5af4dbd80450.w8.b8", !77, i64 0}
!87 = distinct !DISubprogram(name: "cast_compute_", scope: !1, file: !1, type: !88, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !90)
!88 = !DISubroutineType(cc: DW_CC_nocall, types: !89)
!89 = !{!8, !8, !8, !50, !45}
!90 = !{!91, !92, !93, !94}
!91 = !DILocalVariable(name: "M", arg: 1, scope: !87, file: !1, type: !8)
!92 = !DILocalVariable(name: "N", arg: 2, scope: !87, file: !1, type: !8)
!93 = !DILocalVariable(name: "compute", arg: 3, scope: !87, file: !1, type: !50)
!94 = !DILocalVariable(name: "A", arg: 4, scope: !87, file: !1, type: !45)
!95 = !DILocation(line: 0, scope: !87)
!96 = !DILocalVariable(name: "i0", scope: !87, file: !1, type: !8)
!97 = !{!"branch_weights", i32 16129, i32 255}
!98 = !DILocalVariable(name: "i1", scope: !87, file: !1, type: !8)
!99 = !{!"branch_weights", i32 1, i32 127}
!100 = !{!101, !101, i64 0}
!101 = !{!"0x5af4dba4edf0", !19, i64 0}
!102 = !{!103, !103, i64 0}
!103 = !{!"0x5af4dbcddfc0", !19, i64 0}
!104 = !{!"branch_weights", i32 127, i32 16777081}
!105 = distinct !{!105, !106, !107}
!106 = !{!"llvm.loop.isvectorized", i32 1}
!107 = !{!"llvm.loop.unroll.runtime.disable"}
!108 = !{!"branch_weights", i32 1, i32 7}
!109 = !{!"branch_weights", i32 127, i32 0}
!110 = distinct !{!110, !107, !106}
!111 = !{!"branch_weights", i32 127, i32 134217601}
