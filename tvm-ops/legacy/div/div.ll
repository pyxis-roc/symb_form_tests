...
@.str = private constant [54 x i8] c"Assert fail: num_args == 3, div: num_args should be 3\00", align 1
@.str.1 = private constant [13 x i8] c"RuntimeError\00", align 1
@.str.2 = private constant [62 x i8] c"Assert fail: not T.isnullptr(args), div: args pointer is NULL\00", align 1
@.str.3 = private constant [145 x i8] c"Assert fail: var_A_type_index == 0 or var_A_type_index == 4 or var_A_type_index == 7 or var_A_type_index >= 64, div: Expect arg[0] to be pointer\00", align 1
@.str.4 = private constant [145 x i8] c"Assert fail: var_B_type_index == 0 or var_B_type_index == 4 or var_B_type_index == 7 or var_B_type_index >= 64, div: Expect arg[1] to be pointer\00", align 1
@.str.5 = private constant [173 x i8] c"Assert fail: var_T_divide_type_index == 0 or var_T_divide_type_index == 4 or var_T_divide_type_index == 7 or var_T_divide_type_index >= 64, div: Expect arg[2] to be pointer\00", align 1
@.str.6 = private constant [94 x i8] c"Assert fail: not T.isnullptr(var_A), div.var_A is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.7 = private constant [96 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_A, 0, 4, \22int32\22), div.var_A.ndim is expected to equal 2\00", align 1
@.str.8 = private constant [94 x i8] c"Assert fail: not T.isnullptr(var_B), div.var_B is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.9 = private constant [96 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_B, 0, 4, \22int32\22), div.var_B.ndim is expected to equal 2\00", align 1
@.str.10 = private constant [108 x i8] c"Assert fail: not T.isnullptr(var_T_divide), div.var_T_divide is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.11 = private constant [110 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_T_divide, 0, 4, \22int32\22), div.var_T_divide.ndim is expected to equal 2\00", align 1
@.str.12 = private constant [226 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_A, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_A, 0, 7, \22uint16\22) == T.uint16(1), div.var_A.dtype is expected to be float32\00", align 1
@.str.13 = private constant [176 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, div_var_A_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, div_var_A_strides[0])), div.var_A.strides: expected to be compact array\00", align 1
@.str.14 = private constant [186 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22), Argument div.var_A.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22)\00", align 1
@.str.15 = private constant [166 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 10, \22int32\22) == 1, Argument div.var_A.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_A, 0, 10, \22int32\22)\00", align 1
@.str.16 = private constant [99 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(A), div.var_A is expected to have non-NULL data pointer\00", align 1
@.str.17 = private constant [226 x i8] c"Assert fail: T.tvm_struct_get(var_B, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_B, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_B, 0, 7, \22uint16\22) == T.uint16(1), div.var_B.dtype is expected to be float32\00", align 1
@.str.18 = private constant [155 x i8] c"Assert fail: M == T.Cast(\22int32\22, div_var_B_shape[0]), Argument div.var_B.shape[0] has an unsatisfied constraint: M == T.Cast(\22int32\22, div_var_B_shape[0])\00", align 1
@.str.19 = private constant [155 x i8] c"Assert fail: N == T.Cast(\22int32\22, div_var_B_shape[1]), Argument div.var_B.shape[1] has an unsatisfied constraint: N == T.Cast(\22int32\22, div_var_B_shape[1])\00", align 1
@.str.20 = private constant [176 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, div_var_B_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, div_var_B_strides[0])), div.var_B.strides: expected to be compact array\00", align 1
@.str.21 = private constant [186 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_B, 0, 8, \22uint64\22), Argument div.var_B.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_B, 0, 8, \22uint64\22)\00", align 1
@.str.22 = private constant [166 x i8] c"Assert fail: T.tvm_struct_get(var_B, 0, 10, \22int32\22) == 1, Argument div.var_B.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_B, 0, 10, \22int32\22)\00", align 1
@.str.23 = private constant [172 x i8] c"Assert fail: dev_id == T.tvm_struct_get(var_B, 0, 9, \22int32\22), Argument div.var_B.device_id has an unsatisfied constraint: dev_id == T.tvm_struct_get(var_B, 0, 9, \22int32\22)\00", align 1
@.str.24 = private constant [99 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(B), div.var_B is expected to have non-NULL data pointer\00", align 1
@.str.25 = private constant [254 x i8] c"Assert fail: T.tvm_struct_get(var_T_divide, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_T_divide, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_T_divide, 0, 7, \22uint16\22) == T.uint16(1), div.var_T_divide.dtype is expected to be float32\00", align 1
@.str.26 = private constant [176 x i8] c"Assert fail: M == T.Cast(\22int32\22, div_var_T_divide_shape[0]), Argument div.var_T_divide.shape[0] has an unsatisfied constraint: M == T.Cast(\22int32\22, div_var_T_divide_shape[0])\00", align 1
@.str.27 = private constant [176 x i8] c"Assert fail: N == T.Cast(\22int32\22, div_var_T_divide_shape[1]), Argument div.var_T_divide.shape[1] has an unsatisfied constraint: N == T.Cast(\22int32\22, div_var_T_divide_shape[1])\00", align 1
@.str.28 = private constant [197 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, div_var_T_divide_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, div_var_T_divide_strides[0])), div.var_T_divide.strides: expected to be compact array\00", align 1
@.str.29 = private constant [207 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_T_divide, 0, 8, \22uint64\22), Argument div.var_T_divide.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_T_divide, 0, 8, \22uint64\22)\00", align 1
@.str.30 = private constant [187 x i8] c"Assert fail: T.tvm_struct_get(var_T_divide, 0, 10, \22int32\22) == 1, Argument div.var_T_divide.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_T_divide, 0, 10, \22int32\22)\00", align 1
@.str.31 = private constant [193 x i8] c"Assert fail: dev_id == T.tvm_struct_get(var_T_divide, 0, 9, \22int32\22), Argument div.var_T_divide.device_id has an unsatisfied constraint: dev_id == T.tvm_struct_get(var_T_divide, 0, 9, \22int32\22)\00", align 1
@.str.32 = private constant [113 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(T_divide), div.var_T_divide is expected to have non-NULL data pointer\00", align 1
@__tvm_main__ = weak dllexport local_unnamed_addr constant [4 x i8] c"div\00", align 1
@llvm.global_ctors = appending global [0 x { i32, ptr, ptr }] zeroinitializer

define dllexport range(i32 -1, 1) i32 @div(ptr noalias nocapture readnone %self_handle, ptr noalias readonly %args, i32 %num_args, ptr noalias nocapture readnone %result) local_unnamed_addr #0 !dbg !5 {
entry:
...
assert_end6:                                      ; preds = %switch.early.test67, %switch.early.test67, %switch.early.test67, %assert_end4
  ...
  %var_T_divide.type_index = load i32, ptr %8, align 4, !dbg !15
    #dbg_declare(i32 %var_T_divide.type_index, !23, !DIExpression(), !15)
    #dbg_declare(i32 %var_T_divide.type_index, !23, !DIExpression(), !15)
  %var_T_divide.type_index.fr = freeze i32 %var_T_divide.type_index, !dbg !15
  %9 = icmp sgt i32 %var_T_divide.type_index.fr, 63, !dbg !15
  br i1 %9, label %assert_end8, label %switch.early.test68, !dbg !15

switch.early.test68:                              ; preds = %assert_end6
  switch i32 %var_T_divide.type_index.fr, label %assert_fail7 [
...
assert_end8:                                      ; preds = %switch.early.test68, %switch.early.test68, %switch.early.test68, %assert_end6
  ...
  %19 = icmp eq i32 %var_T_divide.type_index.fr, 72, !dbg !15
  %var_T_divide.idx = select i1 %19, i64 16, i64 0, !dbg !15
  %var_T_divide = getelementptr inbounds nuw i8, ptr %18, i64 %var_T_divide.idx, !dbg !15
    #dbg_declare(ptr %var_T_divide, !26, !DIExpression(), !15)
    #dbg_declare(ptr %var_T_divide, !26, !DIExpression(), !15)
...
assert_end12:                                     ; preds = %assert_end10
  ...
  %div.var_A.shape = load ptr, ptr %25, align 8, !dbg !15
    #dbg_declare(ptr %div.var_A.shape, !27, !DIExpression(), !15)
    #dbg_declare(ptr %div.var_A.shape, !27, !DIExpression(), !15)
  %26 = load i64, ptr %div.var_A.shape, align 8, !dbg !15, !tbaa !30
  %M = trunc i64 %26 to i32, !dbg !15
    #dbg_declare(i32 %M, !40, !DIExpression(), !15)
    #dbg_declare(i32 %M, !40, !DIExpression(), !15)
  %27 = getelementptr inbounds nuw i8, ptr %div.var_A.shape, i64 8, !dbg !15
  ...
  %div.var_A.strides = load ptr, ptr %29, align 8, !dbg !15
    #dbg_declare(ptr %div.var_A.strides, !44, !DIExpression(), !15)
    #dbg_declare(ptr %div.var_A.strides, !44, !DIExpression(), !15)
...
assert_end16:                                     ; preds = %assert_end14
  ...
  %div.var_B.shape = load ptr, ptr %36, align 8, !dbg !15
    #dbg_declare(ptr %div.var_B.shape, !49, !DIExpression(), !15)
    #dbg_declare(ptr %div.var_B.shape, !49, !DIExpression(), !15)
  %37 = getelementptr inbounds nuw i8, ptr %var_B, i64 32, !dbg !15
  %div.var_B.strides = load ptr, ptr %37, align 8, !dbg !15
    #dbg_declare(ptr %div.var_B.strides, !50, !DIExpression(), !15)
    #dbg_declare(ptr %div.var_B.strides, !50, !DIExpression(), !15)
...
assert_end18:                                     ; preds = %assert_end16
  %39 = getelementptr inbounds nuw i8, ptr %var_T_divide, i64 16, !dbg !15
...
assert_end20:                                     ; preds = %assert_end18
  %43 = getelementptr inbounds nuw i8, ptr %var_T_divide, i64 24, !dbg !15
  %div.var_T_divide.shape = load ptr, ptr %43, align 8, !dbg !15
    #dbg_declare(ptr %div.var_T_divide.shape, !52, !DIExpression(), !15)
    #dbg_declare(ptr %div.var_T_divide.shape, !52, !DIExpression(), !15)
  %44 = getelementptr inbounds nuw i8, ptr %var_T_divide, i64 32, !dbg !15
  %div.var_T_divide.strides = load ptr, ptr %44, align 8, !dbg !15
    #dbg_declare(ptr %div.var_T_divide.strides, !53, !DIExpression(), !15)
    #dbg_declare(ptr %div.var_T_divide.strides, !53, !DIExpression(), !15)
  %T_divide = load ptr, ptr %var_T_divide, align 8, !dbg !15
    #dbg_declare(ptr %T_divide, !54, !DIExpression(), !15)
    #dbg_declare(ptr %T_divide, !54, !DIExpression(), !15)
  call void @llvm.assume(i1 true) [ "align"(ptr %T_divide, i64 64) ], !dbg !15
...
assert_end32:                                     ; preds = %assert_end30
  %95 = load i64, ptr %div.var_B.shape, align 8, !dbg !15, !tbaa !67
...
assert_end34:                                     ; preds = %assert_end32
  %99 = getelementptr inbounds nuw i8, ptr %div.var_B.shape, i64 8, !dbg !15
...
assert_end48:                                     ; preds = %assert_end46
  %132 = getelementptr inbounds nuw i8, ptr %var_T_divide, i64 22, !dbg !15
  %133 = load i16, ptr %132, align 2, !dbg !15
  %134 = icmp eq i16 %133, 1, !dbg !15
  %135 = getelementptr inbounds nuw i8, ptr %var_T_divide, i64 21, !dbg !15
  %136 = load i8, ptr %135, align 1, !dbg !15
  %137 = icmp eq i8 %136, 32, !dbg !15
  %138 = getelementptr inbounds nuw i8, ptr %var_T_divide, i64 20, !dbg !15
...
assert_end50:                                     ; preds = %assert_end48
  %144 = load i64, ptr %div.var_T_divide.shape, align 8, !dbg !15, !tbaa !91
...
assert_end52:                                     ; preds = %assert_end50
  %148 = getelementptr inbounds nuw i8, ptr %div.var_T_divide.shape, i64 8, !dbg !15
...
assert_end54:                                     ; preds = %assert_end52
  %.not74 = icmp eq ptr %div.var_T_divide.strides, null, !dbg !15
  br i1 %.not74, label %if_end56, label %if_then55, !dbg !15, !prof !20

if_then55:                                        ; preds = %assert_end54
  %153 = load i64, ptr %div.var_T_divide.strides, align 8, !dbg !15, !tbaa !103
  %154 = trunc i64 %153 to i32, !dbg !15
  %155 = icmp eq i32 %N, %154, !dbg !15
  %156 = icmp eq i32 %M, 1, !dbg !15
  %157 = or i1 %156, %155, !dbg !15
  %158 = getelementptr inbounds nuw i8, ptr %div.var_T_divide.strides, i64 8, !dbg !15
...
if_end56:                                         ; preds = %if_then55, %assert_end54
  %165 = getelementptr inbounds nuw i8, ptr %var_T_divide, i64 40, !dbg !15
...
assert_end60:                                     ; preds = %if_end56
  %170 = getelementptr inbounds nuw i8, ptr %var_T_divide, i64 8, !dbg !15
...
assert_end62:                                     ; preds = %assert_end60
  %174 = getelementptr inbounds nuw i8, ptr %var_T_divide, i64 12, !dbg !15
...
assert_end64:                                     ; preds = %assert_end62
  %178 = icmp ne ptr %T_divide, null, !dbg !15
...
assert_end66:                                     ; preds = %assert_end64
  tail call fastcc void @div_compute_(i32 %M, i32 %N, ptr %T_divide, ptr %A, ptr %B), !dbg !15
  br label %common.ret, !dbg !15
}
...
define internal fastcc void @div_compute_(i32 %M, i32 %N, ptr noalias nocapture writeonly align 64 %T_divide, ptr noalias nocapture readonly align 64 %A, ptr noalias nocapture readonly align 64 %B) unnamed_addr #2 !dbg !115 {
entry:
    #dbg_value(i32 %M, !119, !DIExpression(), !124)
    #dbg_value(i32 %N, !120, !DIExpression(), !124)
    #dbg_value(ptr %T_divide, !121, !DIExpression(), !124)
...
vector.body:                                      ; preds = %for_begin_ax1.preheader.us, %vector.body
  ...
  %5 = getelementptr inbounds nuw float, ptr %A, i64 %4, !dbg !124
  %wide.load = load <4 x float>, ptr %5, align 4, !dbg !124, !tbaa !129
  %6 = getelementptr inbounds nuw float, ptr %B, i64 %4, !dbg !124
  %wide.load1 = load <4 x float>, ptr %6, align 4, !dbg !124, !tbaa !131
  %7 = fdiv <4 x float> %wide.load, %wide.load1, !dbg !124
  %8 = getelementptr inbounds nuw float, ptr %T_divide, i64 %4, !dbg !124
  store <4 x float> %7, ptr %8, align 4, !dbg !124, !tbaa !133
  %index.next = add nuw i64 %index, 4, !dbg !124
  %9 = icmp eq i64 %index.next, %n.vec, !dbg !124
  br i1 %9, label %middle.block, label %vector.body, !dbg !124, !prof !135, !llvm.loop !136
...
for_body_ax1.us:                                  ; preds = %for_body_ax1.us.preheader, %for_body_ax1.us
  ...
  %10 = add nuw nsw i64 %indvars.iv, %3, !dbg !124
  %11 = getelementptr inbounds nuw float, ptr %A, i64 %10, !dbg !124
  %12 = load float, ptr %11, align 4, !dbg !124, !tbaa !129
  %13 = getelementptr inbounds nuw float, ptr %B, i64 %10, !dbg !124
  %14 = load float, ptr %13, align 4, !dbg !124, !tbaa !131
  %15 = fdiv float %12, %14, !dbg !124
  %16 = getelementptr inbounds nuw float, ptr %T_divide, i64 %10, !dbg !124
  store float %15, ptr %16, align 4, !dbg !124, !tbaa !133
...
!5 = distinct !DISubprogram(name: "div", scope: !1, file: !1, type: !6, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !10)
...
!23 = !DILocalVariable(name: "var_T_divide.type_index", scope: !5, file: !1, type: !8)
!24 = !DILocalVariable(name: "var_A", scope: !5, file: !1, type: !9)
!25 = !DILocalVariable(name: "var_B", scope: !5, file: !1, type: !9)
!26 = !DILocalVariable(name: "var_T_divide", scope: !5, file: !1, type: !9)
!27 = !DILocalVariable(name: "div.var_A.shape", scope: !5, file: !1, type: !28)
!28 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !29)
!29 = !DIBasicType(name: "int64", size: 64, encoding: DW_ATE_signed)
!30 = !{!31, !31, i64 0}
!31 = !{!"0x640834bb7aa0.w8.b0", !32, i64 0}
!32 = !{!"0x640834bb7aa0.w16.b0", !33, i64 0}
!33 = !{!"0x640834bb7aa0.w32.b0", !34, i64 0}
!34 = !{!"0x640834bb7aa0.w64.b0", !35, i64 0}
!35 = !{!"0x640834bb7aa0.w128.b0", !36, i64 0}
!36 = !{!"0x640834bb7aa0.w256.b0", !37, i64 0}
!37 = !{!"0x640834bb7aa0.w512.b0", !38, i64 0}
!38 = !{!"0x640834bb7aa0.w1024.b0", !39, i64 0}
!39 = !{!"0x640834bb7aa0", !19, i64 0}
!40 = !DILocalVariable(name: "M", scope: !5, file: !1, type: !8)
!41 = !{!42, !42, i64 0}
!42 = !{!"0x640834bb7aa0.w8.b8", !32, i64 0}
!43 = !DILocalVariable(name: "N", scope: !5, file: !1, type: !8)
!44 = !DILocalVariable(name: "div.var_A.strides", scope: !5, file: !1, type: !28)
...
!49 = !DILocalVariable(name: "div.var_B.shape", scope: !5, file: !1, type: !28)
!50 = !DILocalVariable(name: "div.var_B.strides", scope: !5, file: !1, type: !28)
!51 = !DILocalVariable(name: "B", scope: !5, file: !1, type: !47)
!52 = !DILocalVariable(name: "div.var_T_divide.shape", scope: !5, file: !1, type: !28)
!53 = !DILocalVariable(name: "div.var_T_divide.strides", scope: !5, file: !1, type: !28)
!54 = !DILocalVariable(name: "T_divide", scope: !5, file: !1, type: !47)
!55 = !{!56, !56, i64 0}
!56 = !{!"0x640834bb8380.w8.b0", !57, i64 0}
!57 = !{!"0x640834bb8380.w16.b0", !58, i64 0}
!58 = !{!"0x640834bb8380.w32.b0", !59, i64 0}
!59 = !{!"0x640834bb8380.w64.b0", !60, i64 0}
!60 = !{!"0x640834bb8380.w128.b0", !61, i64 0}
!61 = !{!"0x640834bb8380.w256.b0", !62, i64 0}
!62 = !{!"0x640834bb8380.w512.b0", !63, i64 0}
!63 = !{!"0x640834bb8380.w1024.b0", !64, i64 0}
!64 = !{!"0x640834bb8380", !19, i64 0}
!65 = !{!66, !66, i64 0}
!66 = !{!"0x640834bb8380.w8.b8", !57, i64 0}
!67 = !{!68, !68, i64 0}
!68 = !{!"0x640834bbaf60.w8.b0", !69, i64 0}
!69 = !{!"0x640834bbaf60.w16.b0", !70, i64 0}
!70 = !{!"0x640834bbaf60.w32.b0", !71, i64 0}
!71 = !{!"0x640834bbaf60.w64.b0", !72, i64 0}
!72 = !{!"0x640834bbaf60.w128.b0", !73, i64 0}
!73 = !{!"0x640834bbaf60.w256.b0", !74, i64 0}
!74 = !{!"0x640834bbaf60.w512.b0", !75, i64 0}
!75 = !{!"0x640834bbaf60.w1024.b0", !76, i64 0}
!76 = !{!"0x640834bbaf60", !19, i64 0}
!77 = !{!78, !78, i64 0}
!78 = !{!"0x640834bbaf60.w8.b8", !69, i64 0}
!79 = !{!80, !80, i64 0}
!80 = !{!"0x640834bbba50.w8.b0", !81, i64 0}
!81 = !{!"0x640834bbba50.w16.b0", !82, i64 0}
!82 = !{!"0x640834bbba50.w32.b0", !83, i64 0}
!83 = !{!"0x640834bbba50.w64.b0", !84, i64 0}
!84 = !{!"0x640834bbba50.w128.b0", !85, i64 0}
!85 = !{!"0x640834bbba50.w256.b0", !86, i64 0}
!86 = !{!"0x640834bbba50.w512.b0", !87, i64 0}
!87 = !{!"0x640834bbba50.w1024.b0", !88, i64 0}
!88 = !{!"0x640834bbba50", !19, i64 0}
!89 = !{!90, !90, i64 0}
!90 = !{!"0x640834bbba50.w8.b8", !81, i64 0}
!91 = !{!92, !92, i64 0}
!92 = !{!"0x640834bbf880.w8.b0", !93, i64 0}
!93 = !{!"0x640834bbf880.w16.b0", !94, i64 0}
!94 = !{!"0x640834bbf880.w32.b0", !95, i64 0}
!95 = !{!"0x640834bbf880.w64.b0", !96, i64 0}
!96 = !{!"0x640834bbf880.w128.b0", !97, i64 0}
!97 = !{!"0x640834bbf880.w256.b0", !98, i64 0}
!98 = !{!"0x640834bbf880.w512.b0", !99, i64 0}
!99 = !{!"0x640834bbf880.w1024.b0", !100, i64 0}
!100 = !{!"0x640834bbf880", !19, i64 0}
!101 = !{!102, !102, i64 0}
!102 = !{!"0x640834bbf880.w8.b8", !93, i64 0}
!103 = !{!104, !104, i64 0}
!104 = !{!"0x640834bbe930.w8.b0", !105, i64 0}
!105 = !{!"0x640834bbe930.w16.b0", !106, i64 0}
!106 = !{!"0x640834bbe930.w32.b0", !107, i64 0}
!107 = !{!"0x640834bbe930.w64.b0", !108, i64 0}
!108 = !{!"0x640834bbe930.w128.b0", !109, i64 0}
!109 = !{!"0x640834bbe930.w256.b0", !110, i64 0}
!110 = !{!"0x640834bbe930.w512.b0", !111, i64 0}
!111 = !{!"0x640834bbe930.w1024.b0", !112, i64 0}
!112 = !{!"0x640834bbe930", !19, i64 0}
!113 = !{!114, !114, i64 0}
!114 = !{!"0x640834bbe930.w8.b8", !105, i64 0}
!115 = distinct !DISubprogram(name: "div_compute_", scope: !1, file: !1, type: !116, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !118)
...
!121 = !DILocalVariable(name: "T_divide", arg: 3, scope: !115, file: !1, type: !47)
...
!129 = !{!130, !130, i64 0}
!130 = !{!"0x640834bac4b0", !19, i64 0}
!131 = !{!132, !132, i64 0}
!132 = !{!"0x640834b900a0", !19, i64 0}
!133 = !{!134, !134, i64 0}
!134 = !{!"0x640834b2cf90", !19, i64 0}
!135 = !{!"branch_weights", i32 127, i32 33554289}
!136 = distinct !{!136, !137, !138}
!137 = !{!"llvm.loop.isvectorized", i32 1}
!138 = !{!"llvm.loop.unroll.runtime.disable"}
!139 = !{!"branch_weights", i32 1, i32 3}
