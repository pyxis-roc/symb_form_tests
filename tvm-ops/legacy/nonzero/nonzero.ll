...
assert_end42:                                     ; preds = %assert_end40
  tail call fastcc void @nonzero_compute_(i32 %M, i32 %N, ptr %T_not_equal, ptr %A), !dbg !15
  br label %common.ret, !dbg !15
}
...
define internal fastcc void @nonzero_compute_(i32 %M, i32 %N, ptr noalias nocapture writeonly align 64 %T_not_equal, ptr noalias nocapture readonly align 64 %A) unnamed_addr #2 !dbg !88 {
entry:
    #dbg_value(i32 %M, !92, !DIExpression(), !96)
    #dbg_value(i32 %N, !93, !DIExpression(), !96)
    #dbg_value(ptr %T_not_equal, !94, !DIExpression(), !96)
    #dbg_value(ptr %A, !95, !DIExpression(), !96)
    #dbg_declare(i32 0, !97, !DIExpression(), !96)
  %0 = icmp sgt i32 %M, 0, !dbg !96
  %1 = icmp sgt i32 %N, 0
  %or.cond = select i1 %0, i1 %1, i1 false, !dbg !96
  br i1 %or.cond, label %for_begin_ax1.preheader.us.preheader, label %for_end_ax0, !dbg !96, !prof !98

for_begin_ax1.preheader.us.preheader:             ; preds = %entry
  %2 = zext nneg i32 %N to i64, !dbg !96
  %wide.trip.count8 = zext nneg i32 %M to i64, !dbg !96
  %min.iters.check = icmp ult i32 %N, 8
  %n.vec = and i64 %2, 2147483640
  %cmp.n = icmp eq i64 %n.vec, %2
  br label %for_begin_ax1.preheader.us, !dbg !96
...
for_begin_ax1.preheader.us:                       ; preds = %for_begin_ax1.preheader.us.preheader, %for_begin_ax1.for_end_ax1_crit_edge.us
  %indvars.iv5 = phi i64 [ 0, %for_begin_ax1.preheader.us.preheader ], [ %indvars.iv.next6, %for_begin_ax1.for_end_ax1_crit_edge.us ]
    #dbg_declare(i64 %indvars.iv5, !97, !DIExpression(), !96)
    #dbg_declare(i32 0, !99, !DIExpression(), !96)
  %3 = mul nuw nsw i64 %indvars.iv5, %2
  br i1 %min.iters.check, label %for_body_ax1.us.preheader, label %vector.body, !dbg !96, !prof !100

vector.body:                                      ; preds = %for_begin_ax1.preheader.us, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %for_begin_ax1.preheader.us ], !dbg !96
  %4 = add nuw nsw i64 %index, %3, !dbg !96
  %5 = getelementptr inbounds nuw float, ptr %A, i64 %4, !dbg !96
  %6 = getelementptr inbounds nuw i8, ptr %5, i64 16, !dbg !96
  %wide.load = load <4 x float>, ptr %5, align 4, !dbg !96, !tbaa !101
  %wide.load1 = load <4 x float>, ptr %6, align 4, !dbg !96, !tbaa !101
  %7 = fcmp one <4 x float> %wide.load, zeroinitializer, !dbg !96
  %8 = fcmp one <4 x float> %wide.load1, zeroinitializer, !dbg !96
  %9 = zext <4 x i1> %7 to <4 x i8>, !dbg !96
  %10 = zext <4 x i1> %8 to <4 x i8>, !dbg !96
  %11 = getelementptr inbounds nuw i8, ptr %T_not_equal, i64 %4, !dbg !96
  %12 = getelementptr inbounds nuw i8, ptr %11, i64 4, !dbg !96
  store <4 x i8> %9, ptr %11, align 1, !dbg !96, !tbaa !103
  store <4 x i8> %10, ptr %12, align 1, !dbg !96, !tbaa !103
  %index.next = add nuw i64 %index, 8, !dbg !96
  %13 = icmp eq i64 %index.next, %n.vec, !dbg !96
  br i1 %13, label %middle.block, label %vector.body, !dbg !96, !prof !105, !llvm.loop !106

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %for_begin_ax1.for_end_ax1_crit_edge.us, label %for_body_ax1.us.preheader, !dbg !96, !prof !109
...
for_body_ax1.us.preheader:                        ; preds = %for_begin_ax1.preheader.us, %middle.block
  ...
  br label %for_body_ax1.us, !dbg !96
...
for_body_ax1.us:                                  ; preds = %for_body_ax1.us.preheader, %for_body_ax1.us
  %indvars.iv = phi i64 [ %indvars.iv.next, %for_body_ax1.us ], [ %indvars.iv.ph, %for_body_ax1.us.preheader ]
    #dbg_declare(i64 %indvars.iv, !99, !DIExpression(), !96)
  %14 = add nuw nsw i64 %indvars.iv, %3, !dbg !96
  %15 = getelementptr inbounds nuw float, ptr %A, i64 %14, !dbg !96
  %16 = load float, ptr %15, align 4, !dbg !96, !tbaa !101
  %17 = fcmp one float %16, 0.000000e+00, !dbg !96
  %18 = zext i1 %17 to i8, !dbg !96
  %19 = getelementptr inbounds nuw i8, ptr %T_not_equal, i64 %14, !dbg !96
  store i8 %18, ptr %19, align 1, !dbg !96, !tbaa !103
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1, !dbg !96
    #dbg_declare(i64 %indvars.iv.next, !99, !DIExpression(), !96)
  %exitcond.not = icmp eq i64 %indvars.iv.next, %2, !dbg !96
  br i1 %exitcond.not, label %for_begin_ax1.for_end_ax1_crit_edge.us, label %for_body_ax1.us, !dbg !96, !prof !110, !llvm.loop !111

for_begin_ax1.for_end_ax1_crit_edge.us:           ; preds = %for_body_ax1.us, %middle.block
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1, !dbg !96
    #dbg_declare(i64 %indvars.iv.next6, !97, !DIExpression(), !96)
  %exitcond9.not = icmp eq i64 %indvars.iv.next6, %wide.trip.count8, !dbg !96
  br i1 %exitcond9.not, label %for_end_ax0, label %for_begin_ax1.preheader.us, !dbg !96, !prof !112
...
!28 = !{!29, !29, i64 0}
!29 = !{!"0x59b0f43aa5c0.w8.b0", !30, i64 0}
!30 = !{!"0x59b0f43aa5c0.w16.b0", !31, i64 0}
!31 = !{!"0x59b0f43aa5c0.w32.b0", !32, i64 0}
!32 = !{!"0x59b0f43aa5c0.w64.b0", !33, i64 0}
!33 = !{!"0x59b0f43aa5c0.w128.b0", !34, i64 0}
!34 = !{!"0x59b0f43aa5c0.w256.b0", !35, i64 0}
!35 = !{!"0x59b0f43aa5c0.w512.b0", !36, i64 0}
!36 = !{!"0x59b0f43aa5c0.w1024.b0", !37, i64 0}
!37 = !{!"0x59b0f43aa5c0", !19, i64 0}
!38 = !DILocalVariable(name: "M", scope: !5, file: !1, type: !8)
!39 = !{!40, !40, i64 0}
!40 = !{!"0x59b0f43aa5c0.w8.b8", !30, i64 0}
...
!52 = !{!53, !53, i64 0}
!53 = !{!"0x59b0f4466aa0.w8.b0", !54, i64 0}
!54 = !{!"0x59b0f4466aa0.w16.b0", !55, i64 0}
!55 = !{!"0x59b0f4466aa0.w32.b0", !56, i64 0}
!56 = !{!"0x59b0f4466aa0.w64.b0", !57, i64 0}
!57 = !{!"0x59b0f4466aa0.w128.b0", !58, i64 0}
!58 = !{!"0x59b0f4466aa0.w256.b0", !59, i64 0}
!59 = !{!"0x59b0f4466aa0.w512.b0", !60, i64 0}
!60 = !{!"0x59b0f4466aa0.w1024.b0", !61, i64 0}
!61 = !{!"0x59b0f4466aa0", !19, i64 0}
!62 = !{!63, !63, i64 0}
!63 = !{!"0x59b0f4466aa0.w8.b8", !54, i64 0}
!64 = !{!65, !65, i64 0}
!65 = !{!"0x59b0f45c4330.w8.b0", !66, i64 0}
!66 = !{!"0x59b0f45c4330.w16.b0", !67, i64 0}
!67 = !{!"0x59b0f45c4330.w32.b0", !68, i64 0}
!68 = !{!"0x59b0f45c4330.w64.b0", !69, i64 0}
!69 = !{!"0x59b0f45c4330.w128.b0", !70, i64 0}
!70 = !{!"0x59b0f45c4330.w256.b0", !71, i64 0}
!71 = !{!"0x59b0f45c4330.w512.b0", !72, i64 0}
!72 = !{!"0x59b0f45c4330.w1024.b0", !73, i64 0}
!73 = !{!"0x59b0f45c4330", !19, i64 0}
!74 = !{!75, !75, i64 0}
!75 = !{!"0x59b0f45c4330.w8.b8", !66, i64 0}
!76 = !{!77, !77, i64 0}
!77 = !{!"0x59b0f45c4880.w8.b0", !78, i64 0}
!78 = !{!"0x59b0f45c4880.w16.b0", !79, i64 0}
!79 = !{!"0x59b0f45c4880.w32.b0", !80, i64 0}
!80 = !{!"0x59b0f45c4880.w64.b0", !81, i64 0}
!81 = !{!"0x59b0f45c4880.w128.b0", !82, i64 0}
!82 = !{!"0x59b0f45c4880.w256.b0", !83, i64 0}
!83 = !{!"0x59b0f45c4880.w512.b0", !84, i64 0}
!84 = !{!"0x59b0f45c4880.w1024.b0", !85, i64 0}
!85 = !{!"0x59b0f45c4880", !19, i64 0}
!86 = !{!87, !87, i64 0}
!87 = !{!"0x59b0f45c4880.w8.b8", !78, i64 0}
...
!89 = !DISubroutineType(cc: DW_CC_nocall, types: !90)
!90 = !{!8, !8, !8, !50, !45}
!91 = !{!92, !93, !94, !95}
!92 = !DILocalVariable(name: "M", arg: 1, scope: !88, file: !1, type: !8)
!93 = !DILocalVariable(name: "N", arg: 2, scope: !88, file: !1, type: !8)
!94 = !DILocalVariable(name: "T_not_equal", arg: 3, scope: !88, file: !1, type: !50)
!95 = !DILocalVariable(name: "A", arg: 4, scope: !88, file: !1, type: !45)
!96 = !DILocation(line: 0, scope: !88)
!97 = !DILocalVariable(name: "ax0", scope: !88, file: !1, type: !8)
!98 = !{!"branch_weights", i32 16129, i32 255}
!99 = !DILocalVariable(name: "ax1", scope: !88, file: !1, type: !8)
!100 = !{!"branch_weights", i32 1, i32 127}
!101 = !{!102, !102, i64 0}
!102 = !{!"0x59b0f43e9200", !19, i64 0}
!103 = !{!104, !104, i64 0}
!104 = !{!"0x59b0f453b8c0", !19, i64 0}
!105 = !{!"branch_weights", i32 127, i32 16777081}
!106 = distinct !{!106, !107, !108}
!107 = !{!"llvm.loop.isvectorized", i32 1}
!108 = !{!"llvm.loop.unroll.runtime.disable"}
!109 = !{!"branch_weights", i32 1, i32 7}
!110 = !{!"branch_weights", i32 127, i32 0}
!111 = distinct !{!111, !108, !107}
!112 = !{!"branch_weights", i32 127, i32 134217601}
