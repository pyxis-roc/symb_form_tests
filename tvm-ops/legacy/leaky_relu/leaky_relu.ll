...
@.str = private constant [61 x i8] c"Assert fail: num_args == 2, leaky_relu: num_args should be 2\00", align 1
@.str.1 = private constant [13 x i8] c"RuntimeError\00", align 1
@.str.2 = private constant [69 x i8] c"Assert fail: not T.isnullptr(args), leaky_relu: args pointer is NULL\00", align 1
@.str.3 = private constant [152 x i8] c"Assert fail: var_A_type_index == 0 or var_A_type_index == 4 or var_A_type_index == 7 or var_A_type_index >= 64, leaky_relu: Expect arg[0] to be pointer\00", align 1
@.str.4 = private constant [176 x i8] c"Assert fail: var_compute_type_index == 0 or var_compute_type_index == 4 or var_compute_type_index == 7 or var_compute_type_index >= 64, leaky_relu: Expect arg[1] to be pointer\00", align 1
@.str.5 = private constant [101 x i8] c"Assert fail: not T.isnullptr(var_A), leaky_relu.var_A is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.6 = private constant [103 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_A, 0, 4, \22int32\22), leaky_relu.var_A.ndim is expected to equal 2\00", align 1
@.str.7 = private constant [113 x i8] c"Assert fail: not T.isnullptr(var_compute), leaky_relu.var_compute is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.8 = private constant [115 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_compute, 0, 4, \22int32\22), leaky_relu.var_compute.ndim is expected to equal 2\00", align 1
@.str.9 = private constant [233 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_A, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_A, 0, 7, \22uint16\22) == T.uint16(1), leaky_relu.var_A.dtype is expected to be float32\00", align 1
@.str.10 = private constant [197 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, leaky_relu_var_A_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, leaky_relu_var_A_strides[0])), leaky_relu.var_A.strides: expected to be compact array\00", align 1
@.str.11 = private constant [193 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22), Argument leaky_relu.var_A.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22)\00", align 1
@.str.12 = private constant [173 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 10, \22int32\22) == 1, Argument leaky_relu.var_A.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_A, 0, 10, \22int32\22)\00", align 1
@.str.13 = private constant [106 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(A), leaky_relu.var_A is expected to have non-NULL data pointer\00", align 1
@.str.14 = private constant [257 x i8] c"Assert fail: T.tvm_struct_get(var_compute, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_compute, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_compute, 0, 7, \22uint16\22) == T.uint16(1), leaky_relu.var_compute.dtype is expected to be float32\00", align 1
@.str.15 = private constant [194 x i8] c"Assert fail: M == T.Cast(\22int32\22, leaky_relu_var_compute_shape[0]), Argument leaky_relu.var_compute.shape[0] has an unsatisfied constraint: M == T.Cast(\22int32\22, leaky_relu_var_compute_shape[0])\00", align 1
@.str.16 = private constant [194 x i8] c"Assert fail: N == T.Cast(\22int32\22, leaky_relu_var_compute_shape[1]), Argument leaky_relu.var_compute.shape[1] has an unsatisfied constraint: N == T.Cast(\22int32\22, leaky_relu_var_compute_shape[1])\00", align 1
@.str.17 = private constant [215 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, leaky_relu_var_compute_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, leaky_relu_var_compute_strides[0])), leaky_relu.var_compute.strides: expected to be compact array\00", align 1
@.str.18 = private constant [211 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_compute, 0, 8, \22uint64\22), Argument leaky_relu.var_compute.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_compute, 0, 8, \22uint64\22)\00", align 1
@.str.19 = private constant [191 x i8] c"Assert fail: T.tvm_struct_get(var_compute, 0, 10, \22int32\22) == 1, Argument leaky_relu.var_compute.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_compute, 0, 10, \22int32\22)\00", align 1
@.str.20 = private constant [197 x i8] c"Assert fail: dev_id == T.tvm_struct_get(var_compute, 0, 9, \22int32\22), Argument leaky_relu.var_compute.device_id has an unsatisfied constraint: dev_id == T.tvm_struct_get(var_compute, 0, 9, \22int32\22)\00", align 1
@.str.21 = private constant [118 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(compute), leaky_relu.var_compute is expected to have non-NULL data pointer\00", align 1
@__tvm_main__ = weak dllexport local_unnamed_addr constant [11 x i8] c"leaky_relu\00", align 1
@llvm.global_ctors = appending global [0 x { i32, ptr, ptr }] zeroinitializer

define dllexport range(i32 -1, 1) i32 @leaky_relu(ptr noalias nocapture readnone %self_handle, ptr noalias readonly %args, i32 %num_args, ptr noalias nocapture readnone %result) local_unnamed_addr #0 !dbg !5 {
entry:
...
assert_end10:                                     ; preds = %assert_end8
  ...
  %leaky_relu.var_A.shape = load ptr, ptr %19, align 8, !dbg !15
    #dbg_declare(ptr %leaky_relu.var_A.shape, !25, !DIExpression(), !15)
    #dbg_declare(ptr %leaky_relu.var_A.shape, !25, !DIExpression(), !15)
  %20 = load i64, ptr %leaky_relu.var_A.shape, align 8, !dbg !15, !tbaa !28
  %M = trunc i64 %20 to i32, !dbg !15
    #dbg_declare(i32 %M, !38, !DIExpression(), !15)
    #dbg_declare(i32 %M, !38, !DIExpression(), !15)
  %21 = getelementptr inbounds nuw i8, ptr %leaky_relu.var_A.shape, i64 8, !dbg !15
  ...
  %leaky_relu.var_A.strides = load ptr, ptr %23, align 8, !dbg !15
    #dbg_declare(ptr %leaky_relu.var_A.strides, !42, !DIExpression(), !15)
    #dbg_declare(ptr %leaky_relu.var_A.strides, !42, !DIExpression(), !15)
...
assert_end14:                                     ; preds = %assert_end12
  ...
  %leaky_relu.var_compute.shape = load ptr, ptr %30, align 8, !dbg !15
    #dbg_declare(ptr %leaky_relu.var_compute.shape, !47, !DIExpression(), !15)
    #dbg_declare(ptr %leaky_relu.var_compute.shape, !47, !DIExpression(), !15)
  %31 = getelementptr inbounds nuw i8, ptr %var_compute, i64 32, !dbg !15
  %leaky_relu.var_compute.strides = load ptr, ptr %31, align 8, !dbg !15
    #dbg_declare(ptr %leaky_relu.var_compute.strides, !48, !DIExpression(), !15)
    #dbg_declare(ptr %leaky_relu.var_compute.strides, !48, !DIExpression(), !15)
...
assert_end16:                                     ; preds = %assert_end14
  %.not46 = icmp eq ptr %leaky_relu.var_A.strides, null, !dbg !15
  br i1 %.not46, label %if_end, label %if_then, !dbg !15, !prof !20

if_then:                                          ; preds = %assert_end16
  %44 = load i64, ptr %leaky_relu.var_A.strides, align 8, !dbg !15, !tbaa !50
  %45 = trunc i64 %44 to i32, !dbg !15
  %46 = icmp eq i32 %N, %45, !dbg !15
  %47 = icmp eq i32 %M, 1, !dbg !15
  %48 = or i1 %47, %46, !dbg !15
  %49 = getelementptr inbounds nuw i8, ptr %leaky_relu.var_A.strides, i64 8, !dbg !15
...
assert_end26:                                     ; preds = %assert_end24
  %82 = load i64, ptr %leaky_relu.var_compute.shape, align 8, !dbg !15, !tbaa !62
...
assert_end28:                                     ; preds = %assert_end26
  %86 = getelementptr inbounds nuw i8, ptr %leaky_relu.var_compute.shape, i64 8, !dbg !15
...
assert_end30:                                     ; preds = %assert_end28
  %.not47 = icmp eq ptr %leaky_relu.var_compute.strides, null, !dbg !15
  br i1 %.not47, label %if_end32, label %if_then31, !dbg !15, !prof !20

if_then31:                                        ; preds = %assert_end30
  %91 = load i64, ptr %leaky_relu.var_compute.strides, align 8, !dbg !15, !tbaa !74
  %92 = trunc i64 %91 to i32, !dbg !15
  %93 = icmp eq i32 %N, %92, !dbg !15
  %94 = icmp eq i32 %M, 1, !dbg !15
  %95 = or i1 %94, %93, !dbg !15
  %96 = getelementptr inbounds nuw i8, ptr %leaky_relu.var_compute.strides, i64 8, !dbg !15
...
assert_end42:                                     ; preds = %assert_end40
  tail call fastcc void @leaky_relu_compute_(i32 %M, i32 %N, ptr %compute, ptr %A), !dbg !15
  br label %common.ret, !dbg !15
}
...
define internal fastcc void @leaky_relu_compute_(i32 %M, i32 %N, ptr noalias nocapture writeonly align 64 %compute, ptr noalias nocapture readonly align 64 %A) unnamed_addr #2 !dbg !86 {
entry:
...
vector.body:                                      ; preds = %for_begin_i1.preheader.us, %vector.body
  ...
  %6 = getelementptr inbounds nuw i8, ptr %5, i64 16, !dbg !94
  %wide.load = load <4 x float>, ptr %5, align 4, !dbg !94, !tbaa !99
  %wide.load1 = load <4 x float>, ptr %6, align 4, !dbg !94, !tbaa !99
  %7 = fcmp ogt <4 x float> %wide.load, zeroinitializer, !dbg !94
  %8 = fcmp ogt <4 x float> %wide.load1, zeroinitializer, !dbg !94
  %9 = fmul <4 x float> %wide.load, splat (float 0x3FB99999A0000000), !dbg !94
  %10 = fmul <4 x float> %wide.load1, splat (float 0x3FB99999A0000000), !dbg !94
  %11 = select <4 x i1> %7, <4 x float> %wide.load, <4 x float> %9, !dbg !94
  %12 = select <4 x i1> %8, <4 x float> %wide.load1, <4 x float> %10, !dbg !94
  %13 = getelementptr inbounds nuw float, ptr %compute, i64 %4, !dbg !94
  %14 = getelementptr inbounds nuw i8, ptr %13, i64 16, !dbg !94
  store <4 x float> %11, ptr %13, align 4, !dbg !94, !tbaa !101
  store <4 x float> %12, ptr %14, align 4, !dbg !94, !tbaa !101
  %index.next = add nuw i64 %index, 8, !dbg !94
  %15 = icmp eq i64 %index.next, %n.vec, !dbg !94
  br i1 %15, label %middle.block, label %vector.body, !dbg !94, !prof !103, !llvm.loop !104
...
for_body_i1.us:                                   ; preds = %for_body_i1.us.preheader, %for_body_i1.us
  ...
  %16 = add nuw nsw i64 %indvars.iv, %3, !dbg !94
  %17 = getelementptr inbounds nuw float, ptr %A, i64 %16, !dbg !94
  %18 = load float, ptr %17, align 4, !dbg !94, !tbaa !99
  %19 = fcmp ogt float %18, 0.000000e+00, !dbg !94
  %20 = fmul float %18, 0x3FB99999A0000000, !dbg !94
  %21 = select i1 %19, float %18, float %20, !dbg !94
  %22 = getelementptr inbounds nuw float, ptr %compute, i64 %16, !dbg !94
  store float %21, ptr %22, align 4, !dbg !94, !tbaa !101
...
!5 = distinct !DISubprogram(name: "leaky_relu", scope: !1, file: !1, type: !6, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !10)
...
!25 = !DILocalVariable(name: "leaky_relu.var_A.shape", scope: !5, file: !1, type: !26)
!26 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !27)
!27 = !DIBasicType(name: "int64", size: 64, encoding: DW_ATE_signed)
!28 = !{!29, !29, i64 0}
!29 = !{!"0x6528912e4420.w8.b0", !30, i64 0}
!30 = !{!"0x6528912e4420.w16.b0", !31, i64 0}
!31 = !{!"0x6528912e4420.w32.b0", !32, i64 0}
!32 = !{!"0x6528912e4420.w64.b0", !33, i64 0}
!33 = !{!"0x6528912e4420.w128.b0", !34, i64 0}
!34 = !{!"0x6528912e4420.w256.b0", !35, i64 0}
!35 = !{!"0x6528912e4420.w512.b0", !36, i64 0}
!36 = !{!"0x6528912e4420.w1024.b0", !37, i64 0}
!37 = !{!"0x6528912e4420", !19, i64 0}
!38 = !DILocalVariable(name: "M", scope: !5, file: !1, type: !8)
!39 = !{!40, !40, i64 0}
!40 = !{!"0x6528912e4420.w8.b8", !30, i64 0}
!41 = !DILocalVariable(name: "N", scope: !5, file: !1, type: !8)
!42 = !DILocalVariable(name: "leaky_relu.var_A.strides", scope: !5, file: !1, type: !26)
...
!47 = !DILocalVariable(name: "leaky_relu.var_compute.shape", scope: !5, file: !1, type: !26)
!48 = !DILocalVariable(name: "leaky_relu.var_compute.strides", scope: !5, file: !1, type: !26)
!49 = !DILocalVariable(name: "compute", scope: !5, file: !1, type: !45)
!50 = !{!51, !51, i64 0}
!51 = !{!"0x652891211440.w8.b0", !52, i64 0}
!52 = !{!"0x652891211440.w16.b0", !53, i64 0}
!53 = !{!"0x652891211440.w32.b0", !54, i64 0}
!54 = !{!"0x652891211440.w64.b0", !55, i64 0}
!55 = !{!"0x652891211440.w128.b0", !56, i64 0}
!56 = !{!"0x652891211440.w256.b0", !57, i64 0}
!57 = !{!"0x652891211440.w512.b0", !58, i64 0}
!58 = !{!"0x652891211440.w1024.b0", !59, i64 0}
!59 = !{!"0x652891211440", !19, i64 0}
!60 = !{!61, !61, i64 0}
!61 = !{!"0x652891211440.w8.b8", !52, i64 0}
!62 = !{!63, !63, i64 0}
!63 = !{!"0x652891219dd0.w8.b0", !64, i64 0}
!64 = !{!"0x652891219dd0.w16.b0", !65, i64 0}
!65 = !{!"0x652891219dd0.w32.b0", !66, i64 0}
!66 = !{!"0x652891219dd0.w64.b0", !67, i64 0}
!67 = !{!"0x652891219dd0.w128.b0", !68, i64 0}
!68 = !{!"0x652891219dd0.w256.b0", !69, i64 0}
!69 = !{!"0x652891219dd0.w512.b0", !70, i64 0}
!70 = !{!"0x652891219dd0.w1024.b0", !71, i64 0}
!71 = !{!"0x652891219dd0", !19, i64 0}
!72 = !{!73, !73, i64 0}
!73 = !{!"0x652891219dd0.w8.b8", !64, i64 0}
!74 = !{!75, !75, i64 0}
!75 = !{!"0x6528911782a0.w8.b0", !76, i64 0}
!76 = !{!"0x6528911782a0.w16.b0", !77, i64 0}
!77 = !{!"0x6528911782a0.w32.b0", !78, i64 0}
!78 = !{!"0x6528911782a0.w64.b0", !79, i64 0}
!79 = !{!"0x6528911782a0.w128.b0", !80, i64 0}
!80 = !{!"0x6528911782a0.w256.b0", !81, i64 0}
!81 = !{!"0x6528911782a0.w512.b0", !82, i64 0}
!82 = !{!"0x6528911782a0.w1024.b0", !83, i64 0}
!83 = !{!"0x6528911782a0", !19, i64 0}
!84 = !{!85, !85, i64 0}
!85 = !{!"0x6528911782a0.w8.b8", !76, i64 0}
!86 = distinct !DISubprogram(name: "leaky_relu_compute_", scope: !1, file: !1, type: !87, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !89)
...
!99 = !{!100, !100, i64 0}
!100 = !{!"0x652891047240", !19, i64 0}
!101 = !{!102, !102, i64 0}
!102 = !{!"0x652891104860", !19, i64 0}
!103 = !{!"branch_weights", i32 127, i32 16777081}
!104 = distinct !{!104, !105, !106}
!105 = !{!"llvm.loop.isvectorized", i32 1}
!106 = !{!"llvm.loop.unroll.runtime.disable"}
!107 = !{!"branch_weights", i32 1, i32 7}
