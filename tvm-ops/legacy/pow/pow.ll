...
@.str = private constant [54 x i8] c"Assert fail: num_args == 2, pow: num_args should be 2\00", align 1
@.str.1 = private constant [13 x i8] c"RuntimeError\00", align 1
@.str.2 = private constant [62 x i8] c"Assert fail: not T.isnullptr(args), pow: args pointer is NULL\00", align 1
@.str.3 = private constant [145 x i8] c"Assert fail: var_A_type_index == 0 or var_A_type_index == 4 or var_A_type_index == 7 or var_A_type_index >= 64, pow: Expect arg[0] to be pointer\00", align 1
@.str.4 = private constant [169 x i8] c"Assert fail: var_T_power_type_index == 0 or var_T_power_type_index == 4 or var_T_power_type_index == 7 or var_T_power_type_index >= 64, pow: Expect arg[1] to be pointer\00", align 1
@.str.5 = private constant [94 x i8] c"Assert fail: not T.isnullptr(var_A), pow.var_A is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.6 = private constant [96 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_A, 0, 4, \22int32\22), pow.var_A.ndim is expected to equal 2\00", align 1
@.str.7 = private constant [106 x i8] c"Assert fail: not T.isnullptr(var_T_power), pow.var_T_power is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.8 = private constant [108 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_T_power, 0, 4, \22int32\22), pow.var_T_power.ndim is expected to equal 2\00", align 1
@.str.9 = private constant [226 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_A, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_A, 0, 7, \22uint16\22) == T.uint16(1), pow.var_A.dtype is expected to be float32\00", align 1
@.str.10 = private constant [176 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, pow_var_A_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, pow_var_A_strides[0])), pow.var_A.strides: expected to be compact array\00", align 1
@.str.11 = private constant [186 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22), Argument pow.var_A.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22)\00", align 1
@.str.12 = private constant [166 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 10, \22int32\22) == 1, Argument pow.var_A.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_A, 0, 10, \22int32\22)\00", align 1
@.str.13 = private constant [99 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(A), pow.var_A is expected to have non-NULL data pointer\00", align 1
@.str.14 = private constant [250 x i8] c"Assert fail: T.tvm_struct_get(var_T_power, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_T_power, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_T_power, 0, 7, \22uint16\22) == T.uint16(1), pow.var_T_power.dtype is expected to be float32\00", align 1
@.str.15 = private constant [173 x i8] c"Assert fail: M == T.Cast(\22int32\22, pow_var_T_power_shape[0]), Argument pow.var_T_power.shape[0] has an unsatisfied constraint: M == T.Cast(\22int32\22, pow_var_T_power_shape[0])\00", align 1
@.str.16 = private constant [173 x i8] c"Assert fail: N == T.Cast(\22int32\22, pow_var_T_power_shape[1]), Argument pow.var_T_power.shape[1] has an unsatisfied constraint: N == T.Cast(\22int32\22, pow_var_T_power_shape[1])\00", align 1
@.str.17 = private constant [194 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, pow_var_T_power_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, pow_var_T_power_strides[0])), pow.var_T_power.strides: expected to be compact array\00", align 1
@.str.18 = private constant [204 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_T_power, 0, 8, \22uint64\22), Argument pow.var_T_power.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_T_power, 0, 8, \22uint64\22)\00", align 1
@.str.19 = private constant [184 x i8] c"Assert fail: T.tvm_struct_get(var_T_power, 0, 10, \22int32\22) == 1, Argument pow.var_T_power.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_T_power, 0, 10, \22int32\22)\00", align 1
@.str.20 = private constant [190 x i8] c"Assert fail: dev_id == T.tvm_struct_get(var_T_power, 0, 9, \22int32\22), Argument pow.var_T_power.device_id has an unsatisfied constraint: dev_id == T.tvm_struct_get(var_T_power, 0, 9, \22int32\22)\00", align 1
@.str.21 = private constant [111 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(T_power), pow.var_T_power is expected to have non-NULL data pointer\00", align 1
@__tvm_main__ = weak dllexport local_unnamed_addr constant [4 x i8] c"pow\00", align 1
@llvm.global_ctors = appending global [0 x { i32, ptr, ptr }] zeroinitializer

define dllexport range(i32 -1, 1) i32 @pow(ptr noalias nocapture readnone %self_handle, ptr noalias readonly %args, i32 %num_args, ptr noalias nocapture readnone %result) local_unnamed_addr #0 !dbg !5 {
entry:
...
assert_end4:                                      ; preds = %switch.early.test, %switch.early.test, %switch.early.test, %assert_end2
  ...
  %var_T_power.type_index = load i32, ptr %5, align 4, !dbg !15
    #dbg_declare(i32 %var_T_power.type_index, !22, !DIExpression(), !15)
    #dbg_declare(i32 %var_T_power.type_index, !22, !DIExpression(), !15)
  %var_T_power.type_index.fr = freeze i32 %var_T_power.type_index, !dbg !15
  %6 = icmp sgt i32 %var_T_power.type_index.fr, 63, !dbg !15
  br i1 %6, label %assert_end6, label %switch.early.test43, !dbg !15

switch.early.test43:                              ; preds = %assert_end4
  switch i32 %var_T_power.type_index.fr, label %assert_fail5 [
...
assert_end6:                                      ; preds = %switch.early.test43, %switch.early.test43, %switch.early.test43, %assert_end4
  ...
  %13 = icmp eq i32 %var_T_power.type_index.fr, 72, !dbg !15
  %var_T_power.idx = select i1 %13, i64 16, i64 0, !dbg !15
  %var_T_power = getelementptr inbounds nuw i8, ptr %12, i64 %var_T_power.idx, !dbg !15
    #dbg_declare(ptr %var_T_power, !24, !DIExpression(), !15)
    #dbg_declare(ptr %var_T_power, !24, !DIExpression(), !15)
...
assert_end10:                                     ; preds = %assert_end8
  ...
  %pow.var_A.shape = load ptr, ptr %19, align 8, !dbg !15
    #dbg_declare(ptr %pow.var_A.shape, !25, !DIExpression(), !15)
    #dbg_declare(ptr %pow.var_A.shape, !25, !DIExpression(), !15)
  %20 = load i64, ptr %pow.var_A.shape, align 8, !dbg !15, !tbaa !28
  %M = trunc i64 %20 to i32, !dbg !15
    #dbg_declare(i32 %M, !38, !DIExpression(), !15)
    #dbg_declare(i32 %M, !38, !DIExpression(), !15)
  %21 = getelementptr inbounds nuw i8, ptr %pow.var_A.shape, i64 8, !dbg !15
  ...
  %pow.var_A.strides = load ptr, ptr %23, align 8, !dbg !15
    #dbg_declare(ptr %pow.var_A.strides, !42, !DIExpression(), !15)
    #dbg_declare(ptr %pow.var_A.strides, !42, !DIExpression(), !15)
...
assert_end12:                                     ; preds = %assert_end10
  %26 = getelementptr inbounds nuw i8, ptr %var_T_power, i64 16, !dbg !15
...
assert_end14:                                     ; preds = %assert_end12
  %30 = getelementptr inbounds nuw i8, ptr %var_T_power, i64 24, !dbg !15
  %pow.var_T_power.shape = load ptr, ptr %30, align 8, !dbg !15
    #dbg_declare(ptr %pow.var_T_power.shape, !47, !DIExpression(), !15)
    #dbg_declare(ptr %pow.var_T_power.shape, !47, !DIExpression(), !15)
  %31 = getelementptr inbounds nuw i8, ptr %var_T_power, i64 32, !dbg !15
  %pow.var_T_power.strides = load ptr, ptr %31, align 8, !dbg !15
    #dbg_declare(ptr %pow.var_T_power.strides, !48, !DIExpression(), !15)
    #dbg_declare(ptr %pow.var_T_power.strides, !48, !DIExpression(), !15)
  %T_power = load ptr, ptr %var_T_power, align 8, !dbg !15
    #dbg_declare(ptr %T_power, !49, !DIExpression(), !15)
    #dbg_declare(ptr %T_power, !49, !DIExpression(), !15)
  call void @llvm.assume(i1 true) [ "align"(ptr %T_power, i64 64) ], !dbg !15
...
assert_end24:                                     ; preds = %assert_end22
  %70 = getelementptr inbounds nuw i8, ptr %var_T_power, i64 22, !dbg !15
  %71 = load i16, ptr %70, align 2, !dbg !15
  %72 = icmp eq i16 %71, 1, !dbg !15
  %73 = getelementptr inbounds nuw i8, ptr %var_T_power, i64 21, !dbg !15
  %74 = load i8, ptr %73, align 1, !dbg !15
  %75 = icmp eq i8 %74, 32, !dbg !15
  %76 = getelementptr inbounds nuw i8, ptr %var_T_power, i64 20, !dbg !15
...
assert_end26:                                     ; preds = %assert_end24
  %82 = load i64, ptr %pow.var_T_power.shape, align 8, !dbg !15, !tbaa !62
...
assert_end28:                                     ; preds = %assert_end26
  %86 = getelementptr inbounds nuw i8, ptr %pow.var_T_power.shape, i64 8, !dbg !15
...
assert_end30:                                     ; preds = %assert_end28
  %.not47 = icmp eq ptr %pow.var_T_power.strides, null, !dbg !15
  br i1 %.not47, label %if_end32, label %if_then31, !dbg !15, !prof !20

if_then31:                                        ; preds = %assert_end30
  %91 = load i64, ptr %pow.var_T_power.strides, align 8, !dbg !15, !tbaa !74
  %92 = trunc i64 %91 to i32, !dbg !15
  %93 = icmp eq i32 %N, %92, !dbg !15
  %94 = icmp eq i32 %M, 1, !dbg !15
  %95 = or i1 %94, %93, !dbg !15
  %96 = getelementptr inbounds nuw i8, ptr %pow.var_T_power.strides, i64 8, !dbg !15
...
if_end32:                                         ; preds = %if_then31, %assert_end30
  %103 = getelementptr inbounds nuw i8, ptr %var_T_power, i64 40, !dbg !15
...
assert_end36:                                     ; preds = %if_end32
  %108 = getelementptr inbounds nuw i8, ptr %var_T_power, i64 8, !dbg !15
...
assert_end38:                                     ; preds = %assert_end36
  %112 = getelementptr inbounds nuw i8, ptr %var_T_power, i64 12, !dbg !15
...
assert_end40:                                     ; preds = %assert_end38
  %116 = icmp ne ptr %T_power, null, !dbg !15
...
assert_end42:                                     ; preds = %assert_end40
  tail call fastcc void @pow_compute_(i32 %M, i32 %N, ptr %T_power, ptr %A), !dbg !15
  br label %common.ret, !dbg !15
}
...
define internal fastcc void @pow_compute_(i32 %M, i32 %N, ptr noalias nocapture writeonly align 64 %T_power, ptr noalias nocapture readonly align 64 %A) unnamed_addr #2 !dbg !86 {
entry:
    #dbg_value(i32 %M, !90, !DIExpression(), !94)
    #dbg_value(i32 %N, !91, !DIExpression(), !94)
    #dbg_value(ptr %T_power, !92, !DIExpression(), !94)
...
for_begin_ax1.preheader.us:                       ; preds = %for_begin_ax1.preheader.us.preheader, %for_begin_ax1.for_end_ax1_crit_edge.us
  ...
  br i1 %min.iters.check, label %for_body_ax1.us.preheader, label %vector.body, !dbg !94, !prof !98
...
vector.body:                                      ; preds = %for_begin_ax1.preheader.us, %vector.body
  ...
  %7 = fmul <4 x float> %wide.load, %wide.load, !dbg !94
  %8 = fmul <4 x float> %wide.load1, %wide.load1, !dbg !94
  %9 = getelementptr inbounds nuw float, ptr %T_power, i64 %4, !dbg !94
  %10 = getelementptr inbounds nuw i8, ptr %9, i64 16, !dbg !94
  store <4 x float> %7, ptr %9, align 4, !dbg !94, !tbaa !101
  store <4 x float> %8, ptr %10, align 4, !dbg !94, !tbaa !101
  %index.next = add nuw i64 %index, 8, !dbg !94
  %11 = icmp eq i64 %index.next, %n.vec, !dbg !94
  br i1 %11, label %middle.block, label %vector.body, !dbg !94, !prof !103, !llvm.loop !104

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %for_begin_ax1.for_end_ax1_crit_edge.us, label %for_body_ax1.us.preheader, !dbg !94, !prof !107
...
for_body_ax1.us.preheader:                        ; preds = %for_begin_ax1.preheader.us, %middle.block
  ...
  br label %for_body_ax1.us, !dbg !94
...
for_body_ax1.us:                                  ; preds = %for_body_ax1.us.preheader, %for_body_ax1.us
  ...
  %12 = add nuw nsw i64 %indvars.iv, %3, !dbg !94
  %13 = getelementptr inbounds nuw float, ptr %A, i64 %12, !dbg !94
  %14 = load float, ptr %13, align 4, !dbg !94, !tbaa !99
  %square.us = fmul float %14, %14, !dbg !94
  %15 = getelementptr inbounds nuw float, ptr %T_power, i64 %12, !dbg !94
  store float %square.us, ptr %15, align 4, !dbg !94, !tbaa !101
  ...
  br i1 %exitcond.not, label %for_begin_ax1.for_end_ax1_crit_edge.us, label %for_body_ax1.us, !dbg !94, !prof !108, !llvm.loop !109
...
for_begin_ax1.for_end_ax1_crit_edge.us:           ; preds = %for_body_ax1.us, %middle.block
  ...
  br i1 %exitcond9.not, label %for_end_ax0, label %for_begin_ax1.preheader.us, !dbg !94, !prof !110
...
!5 = distinct !DISubprogram(name: "pow", scope: !1, file: !1, type: !6, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !10)
...
!22 = !DILocalVariable(name: "var_T_power.type_index", scope: !5, file: !1, type: !8)
!23 = !DILocalVariable(name: "var_A", scope: !5, file: !1, type: !9)
!24 = !DILocalVariable(name: "var_T_power", scope: !5, file: !1, type: !9)
!25 = !DILocalVariable(name: "pow.var_A.shape", scope: !5, file: !1, type: !26)
!26 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !27)
!27 = !DIBasicType(name: "int64", size: 64, encoding: DW_ATE_signed)
!28 = !{!29, !29, i64 0}
!29 = !{!"0x64b1c421fd10.w8.b0", !30, i64 0}
!30 = !{!"0x64b1c421fd10.w16.b0", !31, i64 0}
!31 = !{!"0x64b1c421fd10.w32.b0", !32, i64 0}
!32 = !{!"0x64b1c421fd10.w64.b0", !33, i64 0}
!33 = !{!"0x64b1c421fd10.w128.b0", !34, i64 0}
!34 = !{!"0x64b1c421fd10.w256.b0", !35, i64 0}
!35 = !{!"0x64b1c421fd10.w512.b0", !36, i64 0}
!36 = !{!"0x64b1c421fd10.w1024.b0", !37, i64 0}
!37 = !{!"0x64b1c421fd10", !19, i64 0}
!38 = !DILocalVariable(name: "M", scope: !5, file: !1, type: !8)
!39 = !{!40, !40, i64 0}
!40 = !{!"0x64b1c421fd10.w8.b8", !30, i64 0}
!41 = !DILocalVariable(name: "N", scope: !5, file: !1, type: !8)
!42 = !DILocalVariable(name: "pow.var_A.strides", scope: !5, file: !1, type: !26)
...
!47 = !DILocalVariable(name: "pow.var_T_power.shape", scope: !5, file: !1, type: !26)
!48 = !DILocalVariable(name: "pow.var_T_power.strides", scope: !5, file: !1, type: !26)
!49 = !DILocalVariable(name: "T_power", scope: !5, file: !1, type: !45)
!50 = !{!51, !51, i64 0}
!51 = !{!"0x64b1c4220880.w8.b0", !52, i64 0}
!52 = !{!"0x64b1c4220880.w16.b0", !53, i64 0}
!53 = !{!"0x64b1c4220880.w32.b0", !54, i64 0}
!54 = !{!"0x64b1c4220880.w64.b0", !55, i64 0}
!55 = !{!"0x64b1c4220880.w128.b0", !56, i64 0}
!56 = !{!"0x64b1c4220880.w256.b0", !57, i64 0}
!57 = !{!"0x64b1c4220880.w512.b0", !58, i64 0}
!58 = !{!"0x64b1c4220880.w1024.b0", !59, i64 0}
!59 = !{!"0x64b1c4220880", !19, i64 0}
!60 = !{!61, !61, i64 0}
!61 = !{!"0x64b1c4220880.w8.b8", !52, i64 0}
!62 = !{!63, !63, i64 0}
!63 = !{!"0x64b1c4222ff0.w8.b0", !64, i64 0}
!64 = !{!"0x64b1c4222ff0.w16.b0", !65, i64 0}
!65 = !{!"0x64b1c4222ff0.w32.b0", !66, i64 0}
!66 = !{!"0x64b1c4222ff0.w64.b0", !67, i64 0}
!67 = !{!"0x64b1c4222ff0.w128.b0", !68, i64 0}
!68 = !{!"0x64b1c4222ff0.w256.b0", !69, i64 0}
!69 = !{!"0x64b1c4222ff0.w512.b0", !70, i64 0}
!70 = !{!"0x64b1c4222ff0.w1024.b0", !71, i64 0}
!71 = !{!"0x64b1c4222ff0", !19, i64 0}
!72 = !{!73, !73, i64 0}
!73 = !{!"0x64b1c4222ff0.w8.b8", !64, i64 0}
!74 = !{!75, !75, i64 0}
!75 = !{!"0x64b1c4223ae0.w8.b0", !76, i64 0}
!76 = !{!"0x64b1c4223ae0.w16.b0", !77, i64 0}
!77 = !{!"0x64b1c4223ae0.w32.b0", !78, i64 0}
!78 = !{!"0x64b1c4223ae0.w64.b0", !79, i64 0}
!79 = !{!"0x64b1c4223ae0.w128.b0", !80, i64 0}
!80 = !{!"0x64b1c4223ae0.w256.b0", !81, i64 0}
!81 = !{!"0x64b1c4223ae0.w512.b0", !82, i64 0}
!82 = !{!"0x64b1c4223ae0.w1024.b0", !83, i64 0}
!83 = !{!"0x64b1c4223ae0", !19, i64 0}
!84 = !{!85, !85, i64 0}
!85 = !{!"0x64b1c4223ae0.w8.b8", !76, i64 0}
!86 = distinct !DISubprogram(name: "pow_compute_", scope: !1, file: !1, type: !87, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !89)
...
!92 = !DILocalVariable(name: "T_power", arg: 3, scope: !86, file: !1, type: !45)
...
!99 = !{!100, !100, i64 0}
!100 = !{!"0x64b1c41a3080", !19, i64 0}
!101 = !{!102, !102, i64 0}
!102 = !{!"0x64b1c4153840", !19, i64 0}
