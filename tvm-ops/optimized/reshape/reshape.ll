...
@.str = private constant [58 x i8] c"Assert fail: num_args == 2, reshape: num_args should be 2\00", align 1
@.str.1 = private constant [13 x i8] c"RuntimeError\00", align 1
@.str.2 = private constant [66 x i8] c"Assert fail: not T.isnullptr(args), reshape: args pointer is NULL\00", align 1
@.str.3 = private constant [149 x i8] c"Assert fail: var_A_type_index == 0 or var_A_type_index == 4 or var_A_type_index == 7 or var_A_type_index >= 64, reshape: Expect arg[0] to be pointer\00", align 1
@.str.4 = private constant [181 x i8] c"Assert fail: var_T_reshape_type_index == 0 or var_T_reshape_type_index == 4 or var_T_reshape_type_index == 7 or var_T_reshape_type_index >= 64, reshape: Expect arg[1] to be pointer\00", align 1
@.str.5 = private constant [98 x i8] c"Assert fail: not T.isnullptr(var_A), reshape.var_A is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.6 = private constant [100 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_A, 0, 4, \22int32\22), reshape.var_A.ndim is expected to equal 2\00", align 1
@.str.7 = private constant [114 x i8] c"Assert fail: not T.isnullptr(var_T_reshape), reshape.var_T_reshape is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.8 = private constant [116 x i8] c"Assert fail: 1 == T.tvm_struct_get(var_T_reshape, 0, 4, \22int32\22), reshape.var_T_reshape.ndim is expected to equal 1\00", align 1
@.str.9 = private constant [230 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_A, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_A, 0, 7, \22uint16\22) == T.uint16(1), reshape.var_A.dtype is expected to be float32\00", align 1
@.str.10 = private constant [188 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, reshape_var_A_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, reshape_var_A_strides[0])), reshape.var_A.strides: expected to be compact array\00", align 1
@.str.11 = private constant [190 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22), Argument reshape.var_A.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22)\00", align 1
@.str.12 = private constant [170 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 10, \22int32\22) == 1, Argument reshape.var_A.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_A, 0, 10, \22int32\22)\00", align 1
@.str.13 = private constant [103 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(A), reshape.var_A is expected to have non-NULL data pointer\00", align 1
@.str.14 = private constant [262 x i8] c"Assert fail: T.tvm_struct_get(var_T_reshape, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_T_reshape, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_T_reshape, 0, 7, \22uint16\22) == T.uint16(1), reshape.var_T_reshape.dtype is expected to be float32\00", align 1
@.str.15 = private constant [199 x i8] c"Assert fail: M * N == T.Cast(\22int32\22, reshape_var_T_reshape_shape[0]), Argument reshape.var_T_reshape.shape[0] has an unsatisfied constraint: M * N == T.Cast(\22int32\22, reshape_var_T_reshape_shape[0])\00", align 1
@.str.16 = private constant [143 x i8] c"Assert fail: M * N == 1 or 1 == T.Cast(\22int32\22, reshape_var_T_reshape_strides[0]), reshape.var_T_reshape.strides: expected to be compact array\00", align 1
@.str.17 = private constant [214 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_T_reshape, 0, 8, \22uint64\22), Argument reshape.var_T_reshape.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_T_reshape, 0, 8, \22uint64\22)\00", align 1
@.str.18 = private constant [194 x i8] c"Assert fail: T.tvm_struct_get(var_T_reshape, 0, 10, \22int32\22) == 1, Argument reshape.var_T_reshape.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_T_reshape, 0, 10, \22int32\22)\00", align 1
@.str.19 = private constant [200 x i8] c"Assert fail: dev_id == T.tvm_struct_get(var_T_reshape, 0, 9, \22int32\22), Argument reshape.var_T_reshape.device_id has an unsatisfied constraint: dev_id == T.tvm_struct_get(var_T_reshape, 0, 9, \22int32\22)\00", align 1
@.str.20 = private constant [119 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(T_reshape), reshape.var_T_reshape is expected to have non-NULL data pointer\00", align 1
@__tvm_main__ = weak dllexport local_unnamed_addr constant [8 x i8] c"reshape\00", align 1
@llvm.global_ctors = appending global [0 x { i32, ptr, ptr }] zeroinitializer

define dllexport range(i32 -1, 1) i32 @reshape(ptr noalias nocapture readnone %self_handle, ptr noalias readonly %args, i32 %num_args, ptr noalias nocapture readnone %result) local_unnamed_addr #0 !dbg !5 {
entry:
...
assert_end4:                                      ; preds = %switch.early.test, %switch.early.test, %switch.early.test, %assert_end2
  ...
  %var_T_reshape.type_index = load i32, ptr %5, align 4, !dbg !15
    #dbg_declare(i32 %var_T_reshape.type_index, !22, !DIExpression(), !15)
    #dbg_declare(i32 %var_T_reshape.type_index, !22, !DIExpression(), !15)
  %var_T_reshape.type_index.fr = freeze i32 %var_T_reshape.type_index, !dbg !15
  %6 = icmp sgt i32 %var_T_reshape.type_index.fr, 63, !dbg !15
  br i1 %6, label %assert_end6, label %switch.early.test41, !dbg !15

switch.early.test41:                              ; preds = %assert_end4
  switch i32 %var_T_reshape.type_index.fr, label %assert_fail5 [
...
assert_end6:                                      ; preds = %switch.early.test41, %switch.early.test41, %switch.early.test41, %assert_end4
  ...
  %13 = icmp eq i32 %var_T_reshape.type_index.fr, 72, !dbg !15
  %var_T_reshape.idx = select i1 %13, i64 16, i64 0, !dbg !15
  %var_T_reshape = getelementptr inbounds nuw i8, ptr %12, i64 %var_T_reshape.idx, !dbg !15
    #dbg_declare(ptr %var_T_reshape, !24, !DIExpression(), !15)
    #dbg_declare(ptr %var_T_reshape, !24, !DIExpression(), !15)
...
assert_end10:                                     ; preds = %assert_end8
  ...
  %reshape.var_A.shape = load ptr, ptr %19, align 8, !dbg !15
    #dbg_declare(ptr %reshape.var_A.shape, !25, !DIExpression(), !15)
    #dbg_declare(ptr %reshape.var_A.shape, !25, !DIExpression(), !15)
  %20 = load i64, ptr %reshape.var_A.shape, align 8, !dbg !15, !tbaa !28
  %M = trunc i64 %20 to i32, !dbg !15
    #dbg_declare(i32 %M, !38, !DIExpression(), !15)
    #dbg_declare(i32 %M, !38, !DIExpression(), !15)
  %21 = getelementptr inbounds nuw i8, ptr %reshape.var_A.shape, i64 8, !dbg !15
  ...
  %reshape.var_A.strides = load ptr, ptr %23, align 8, !dbg !15
    #dbg_declare(ptr %reshape.var_A.strides, !42, !DIExpression(), !15)
    #dbg_declare(ptr %reshape.var_A.strides, !42, !DIExpression(), !15)
...
assert_end12:                                     ; preds = %assert_end10
  %26 = getelementptr inbounds nuw i8, ptr %var_T_reshape, i64 16, !dbg !15
...
assert_end14:                                     ; preds = %assert_end12
  %30 = getelementptr inbounds nuw i8, ptr %var_T_reshape, i64 24, !dbg !15
  %reshape.var_T_reshape.shape = load ptr, ptr %30, align 8, !dbg !15
    #dbg_declare(ptr %reshape.var_T_reshape.shape, !47, !DIExpression(), !15)
    #dbg_declare(ptr %reshape.var_T_reshape.shape, !47, !DIExpression(), !15)
  %31 = getelementptr inbounds nuw i8, ptr %var_T_reshape, i64 32, !dbg !15
  %reshape.var_T_reshape.strides = load ptr, ptr %31, align 8, !dbg !15
    #dbg_declare(ptr %reshape.var_T_reshape.strides, !48, !DIExpression(), !15)
    #dbg_declare(ptr %reshape.var_T_reshape.strides, !48, !DIExpression(), !15)
  %T_reshape = load ptr, ptr %var_T_reshape, align 8, !dbg !15
    #dbg_declare(ptr %T_reshape, !49, !DIExpression(), !15)
    #dbg_declare(ptr %T_reshape, !49, !DIExpression(), !15)
  call void @llvm.assume(i1 true) [ "align"(ptr %T_reshape, i64 64) ], !dbg !15
...
assert_end16:                                     ; preds = %assert_end14
  %.not44 = icmp eq ptr %reshape.var_A.strides, null, !dbg !15
  br i1 %.not44, label %if_end, label %if_then, !dbg !15, !prof !20

if_then:                                          ; preds = %assert_end16
  %44 = load i64, ptr %reshape.var_A.strides, align 8, !dbg !15, !tbaa !50
  %45 = trunc i64 %44 to i32, !dbg !15
  %46 = icmp eq i32 %N, %45, !dbg !15
  %47 = icmp eq i32 %M, 1, !dbg !15
  %48 = or i1 %47, %46, !dbg !15
  %49 = getelementptr inbounds nuw i8, ptr %reshape.var_A.strides, i64 8, !dbg !15
...
assert_end24:                                     ; preds = %assert_end22
  %70 = getelementptr inbounds nuw i8, ptr %var_T_reshape, i64 22, !dbg !15
  %71 = load i16, ptr %70, align 2, !dbg !15
  %72 = icmp eq i16 %71, 1, !dbg !15
  %73 = getelementptr inbounds nuw i8, ptr %var_T_reshape, i64 21, !dbg !15
  %74 = load i8, ptr %73, align 1, !dbg !15
  %75 = icmp eq i8 %74, 32, !dbg !15
  %76 = getelementptr inbounds nuw i8, ptr %var_T_reshape, i64 20, !dbg !15
...
assert_end26:                                     ; preds = %assert_end24
  %82 = load i64, ptr %reshape.var_T_reshape.shape, align 8, !dbg !15, !tbaa !62
  %83 = trunc i64 %82 to i32, !dbg !15
  %84 = icmp eq i32 %66, %83, !dbg !15
...
assert_end34:                                     ; preds = %if_end30
  %96 = getelementptr inbounds nuw i8, ptr %var_T_reshape, i64 8, !dbg !15
...
assert_end36:                                     ; preds = %assert_end34
  %100 = getelementptr inbounds nuw i8, ptr %var_T_reshape, i64 12, !dbg !15
...
assert_end38:                                     ; preds = %assert_end36
  %104 = icmp ne ptr %T_reshape, null, !dbg !15
  %105 = or i1 %67, %104, !dbg !15
  br i1 %105, label %assert_end40, label %assert_fail39, !dbg !15, !prof !16

assert_fail39:                                    ; preds = %assert_end38
  %106 = load ptr, ptr @__TVMFFIErrorSetRaisedFromCStr, align 8, !dbg !15, !tbaa !17
  tail call void %106(ptr nonnull @.str.1, ptr nonnull @.str.20), !dbg !15
  br label %common.ret, !dbg !15

assert_end40:                                     ; preds = %assert_end38
  tail call fastcc void @reshape_compute_(i32 %M, i32 %N, ptr %T_reshape, ptr %A), !dbg !15
  br label %common.ret, !dbg !15
}
...
define internal fastcc void @reshape_compute_(i32 %M, i32 %N, ptr noalias nocapture writeonly align 64 %T_reshape, ptr noalias nocapture readonly align 64 %A) unnamed_addr #2 !dbg !82 {
entry:
    #dbg_value(i32 %M, !86, !DIExpression(), !90)
    #dbg_value(i32 %N, !87, !DIExpression(), !90)
    #dbg_value(ptr %T_reshape, !88, !DIExpression(), !90)
    #dbg_value(ptr %A, !89, !DIExpression(), !90)
  %0 = mul nsw i32 %N, %M, !dbg !90
    #dbg_declare(i32 0, !91, !DIExpression(), !90)
  %1 = icmp sgt i32 %0, 0, !dbg !90
  br i1 %1, label %for_body_ax0.preheader, label %for_end_ax0, !dbg !90, !prof !92

for_body_ax0.preheader:                           ; preds = %entry
  %2 = zext nneg i32 %0 to i64, !dbg !90
  %3 = shl nuw nsw i64 %2, 2, !dbg !90
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 64 %T_reshape, ptr align 64 %A, i64 %3, i1 false), !dbg !90
    #dbg_declare(i64 poison, !91, !DIExpression(), !90)
  br label %for_end_ax0, !dbg !90
...
!5 = distinct !DISubprogram(name: "reshape", scope: !1, file: !1, type: !6, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !10)
...
!22 = !DILocalVariable(name: "var_T_reshape.type_index", scope: !5, file: !1, type: !8)
!23 = !DILocalVariable(name: "var_A", scope: !5, file: !1, type: !9)
!24 = !DILocalVariable(name: "var_T_reshape", scope: !5, file: !1, type: !9)
!25 = !DILocalVariable(name: "reshape.var_A.shape", scope: !5, file: !1, type: !26)
!26 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !27)
!27 = !DIBasicType(name: "int64", size: 64, encoding: DW_ATE_signed)
!28 = !{!29, !29, i64 0}
!29 = !{!"0x63a8dd18ce00.w8.b0", !30, i64 0}
!30 = !{!"0x63a8dd18ce00.w16.b0", !31, i64 0}
!31 = !{!"0x63a8dd18ce00.w32.b0", !32, i64 0}
!32 = !{!"0x63a8dd18ce00.w64.b0", !33, i64 0}
!33 = !{!"0x63a8dd18ce00.w128.b0", !34, i64 0}
!34 = !{!"0x63a8dd18ce00.w256.b0", !35, i64 0}
!35 = !{!"0x63a8dd18ce00.w512.b0", !36, i64 0}
!36 = !{!"0x63a8dd18ce00.w1024.b0", !37, i64 0}
!37 = !{!"0x63a8dd18ce00", !19, i64 0}
!38 = !DILocalVariable(name: "M", scope: !5, file: !1, type: !8)
!39 = !{!40, !40, i64 0}
!40 = !{!"0x63a8dd18ce00.w8.b8", !30, i64 0}
!41 = !DILocalVariable(name: "N", scope: !5, file: !1, type: !8)
!42 = !DILocalVariable(name: "reshape.var_A.strides", scope: !5, file: !1, type: !26)
...
!47 = !DILocalVariable(name: "reshape.var_T_reshape.shape", scope: !5, file: !1, type: !26)
!48 = !DILocalVariable(name: "reshape.var_T_reshape.strides", scope: !5, file: !1, type: !26)
!49 = !DILocalVariable(name: "T_reshape", scope: !5, file: !1, type: !45)
!50 = !{!51, !51, i64 0}
!51 = !{!"0x63a8dd1b3250.w8.b0", !52, i64 0}
!52 = !{!"0x63a8dd1b3250.w16.b0", !53, i64 0}
!53 = !{!"0x63a8dd1b3250.w32.b0", !54, i64 0}
!54 = !{!"0x63a8dd1b3250.w64.b0", !55, i64 0}
!55 = !{!"0x63a8dd1b3250.w128.b0", !56, i64 0}
!56 = !{!"0x63a8dd1b3250.w256.b0", !57, i64 0}
!57 = !{!"0x63a8dd1b3250.w512.b0", !58, i64 0}
!58 = !{!"0x63a8dd1b3250.w1024.b0", !59, i64 0}
!59 = !{!"0x63a8dd1b3250", !19, i64 0}
!60 = !{!61, !61, i64 0}
!61 = !{!"0x63a8dd1b3250.w8.b8", !52, i64 0}
!62 = !{!63, !63, i64 0}
!63 = !{!"0x63a8dcf3f530.w8.b0", !64, i64 0}
!64 = !{!"0x63a8dcf3f530.w16.b0", !65, i64 0}
!65 = !{!"0x63a8dcf3f530.w32.b0", !66, i64 0}
!66 = !{!"0x63a8dcf3f530.w64.b0", !67, i64 0}
!67 = !{!"0x63a8dcf3f530.w128.b0", !68, i64 0}
!68 = !{!"0x63a8dcf3f530.w256.b0", !69, i64 0}
!69 = !{!"0x63a8dcf3f530.w512.b0", !70, i64 0}
!70 = !{!"0x63a8dcf3f530.w1024.b0", !71, i64 0}
!71 = !{!"0x63a8dcf3f530", !19, i64 0}
!72 = !{!73, !73, i64 0}
!73 = !{!"0x63a8dd205a60.w8.b0", !74, i64 0}
!74 = !{!"0x63a8dd205a60.w16.b0", !75, i64 0}
!75 = !{!"0x63a8dd205a60.w32.b0", !76, i64 0}
!76 = !{!"0x63a8dd205a60.w64.b0", !77, i64 0}
!77 = !{!"0x63a8dd205a60.w128.b0", !78, i64 0}
!78 = !{!"0x63a8dd205a60.w256.b0", !79, i64 0}
!79 = !{!"0x63a8dd205a60.w512.b0", !80, i64 0}
!80 = !{!"0x63a8dd205a60.w1024.b0", !81, i64 0}
!81 = !{!"0x63a8dd205a60", !19, i64 0}
!82 = distinct !DISubprogram(name: "reshape_compute_", scope: !1, file: !1, type: !83, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !85)
...
!88 = !DILocalVariable(name: "T_reshape", arg: 3, scope: !82, file: !1, type: !45)
