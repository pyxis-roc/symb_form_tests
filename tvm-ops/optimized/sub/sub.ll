...
@.str.3 = private constant [145 x i8] c"Assert fail: var_A_type_index == 0 or var_A_type_index == 4 or var_A_type_index == 7 or var_A_type_index >= 64, sub: Expect arg[0] to be pointer\00", align 1
@.str.4 = private constant [145 x i8] c"Assert fail: var_B_type_index == 0 or var_B_type_index == 4 or var_B_type_index == 7 or var_B_type_index >= 64, sub: Expect arg[1] to be pointer\00", align 1
@.str.5 = private constant [181 x i8] c"Assert fail: var_T_subtract_type_index == 0 or var_T_subtract_type_index == 4 or var_T_subtract_type_index == 7 or var_T_subtract_type_index >= 64, sub: Expect arg[2] to be pointer\00", align 1
@.str.6 = private constant [94 x i8] c"Assert fail: not T.isnullptr(var_A), sub.var_A is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.7 = private constant [96 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_A, 0, 4, \22int32\22), sub.var_A.ndim is expected to equal 2\00", align 1
@.str.8 = private constant [94 x i8] c"Assert fail: not T.isnullptr(var_B), sub.var_B is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.9 = private constant [96 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_B, 0, 4, \22int32\22), sub.var_B.ndim is expected to equal 2\00", align 1
@.str.10 = private constant [112 x i8] c"Assert fail: not T.isnullptr(var_T_subtract), sub.var_T_subtract is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.11 = private constant [114 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_T_subtract, 0, 4, \22int32\22), sub.var_T_subtract.ndim is expected to equal 2\00", align 1
@.str.12 = private constant [226 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_A, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_A, 0, 7, \22uint16\22) == T.uint16(1), sub.var_A.dtype is expected to be float32\00", align 1
@.str.13 = private constant [176 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, sub_var_A_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, sub_var_A_strides[0])), sub.var_A.strides: expected to be compact array\00", align 1
@.str.14 = private constant [186 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22), Argument sub.var_A.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22)\00", align 1
@.str.15 = private constant [166 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 10, \22int32\22) == 1, Argument sub.var_A.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_A, 0, 10, \22int32\22)\00", align 1
@.str.16 = private constant [99 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(A), sub.var_A is expected to have non-NULL data pointer\00", align 1
@.str.17 = private constant [226 x i8] c"Assert fail: T.tvm_struct_get(var_B, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_B, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_B, 0, 7, \22uint16\22) == T.uint16(1), sub.var_B.dtype is expected to be float32\00", align 1
@.str.18 = private constant [155 x i8] c"Assert fail: M == T.Cast(\22int32\22, sub_var_B_shape[0]), Argument sub.var_B.shape[0] has an unsatisfied constraint: M == T.Cast(\22int32\22, sub_var_B_shape[0])\00", align 1
@.str.19 = private constant [155 x i8] c"Assert fail: N == T.Cast(\22int32\22, sub_var_B_shape[1]), Argument sub.var_B.shape[1] has an unsatisfied constraint: N == T.Cast(\22int32\22, sub_var_B_shape[1])\00", align 1
@.str.20 = private constant [176 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, sub_var_B_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, sub_var_B_strides[0])), sub.var_B.strides: expected to be compact array\00", align 1
@.str.21 = private constant [186 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_B, 0, 8, \22uint64\22), Argument sub.var_B.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_B, 0, 8, \22uint64\22)\00", align 1
@.str.22 = private constant [166 x i8] c"Assert fail: T.tvm_struct_get(var_B, 0, 10, \22int32\22) == 1, Argument sub.var_B.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_B, 0, 10, \22int32\22)\00", align 1
@.str.23 = private constant [172 x i8] c"Assert fail: dev_id == T.tvm_struct_get(var_B, 0, 9, \22int32\22), Argument sub.var_B.device_id has an unsatisfied constraint: dev_id == T.tvm_struct_get(var_B, 0, 9, \22int32\22)\00", align 1
@.str.24 = private constant [99 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(B), sub.var_B is expected to have non-NULL data pointer\00", align 1
@.str.25 = private constant [262 x i8] c"Assert fail: T.tvm_struct_get(var_T_subtract, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_T_subtract, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_T_subtract, 0, 7, \22uint16\22) == T.uint16(1), sub.var_T_subtract.dtype is expected to be float32\00", align 1
@.str.26 = private constant [182 x i8] c"Assert fail: M == T.Cast(\22int32\22, sub_var_T_subtract_shape[0]), Argument sub.var_T_subtract.shape[0] has an unsatisfied constraint: M == T.Cast(\22int32\22, sub_var_T_subtract_shape[0])\00", align 1
@.str.27 = private constant [182 x i8] c"Assert fail: N == T.Cast(\22int32\22, sub_var_T_subtract_shape[1]), Argument sub.var_T_subtract.shape[1] has an unsatisfied constraint: N == T.Cast(\22int32\22, sub_var_T_subtract_shape[1])\00", align 1
@.str.28 = private constant [203 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, sub_var_T_subtract_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, sub_var_T_subtract_strides[0])), sub.var_T_subtract.strides: expected to be compact array\00", align 1
@.str.29 = private constant [213 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_T_subtract, 0, 8, \22uint64\22), Argument sub.var_T_subtract.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_T_subtract, 0, 8, \22uint64\22)\00", align 1
@.str.30 = private constant [193 x i8] c"Assert fail: T.tvm_struct_get(var_T_subtract, 0, 10, \22int32\22) == 1, Argument sub.var_T_subtract.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_T_subtract, 0, 10, \22int32\22)\00", align 1
@.str.31 = private constant [199 x i8] c"Assert fail: dev_id == T.tvm_struct_get(var_T_subtract, 0, 9, \22int32\22), Argument sub.var_T_subtract.device_id has an unsatisfied constraint: dev_id == T.tvm_struct_get(var_T_subtract, 0, 9, \22int32\22)\00", align 1
@.str.32 = private constant [117 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(T_subtract), sub.var_T_subtract is expected to have non-NULL data pointer\00", align 1
@__tvm_main__ = weak dllexport local_unnamed_addr constant [4 x i8] c"sub\00", align 1
@llvm.global_ctors = appending global [0 x { i32, ptr, ptr }] zeroinitializer

define dllexport range(i32 -1, 1) i32 @sub(ptr noalias nocapture readnone %self_handle, ptr noalias readonly %args, i32 %num_args, ptr noalias nocapture readnone %result) local_unnamed_addr #0 !dbg !5 {
entry:
...
assert_end6:                                      ; preds = %switch.early.test67, %switch.early.test67, %switch.early.test67, %assert_end4
  ...
  %var_T_subtract.type_index = load i32, ptr %8, align 4, !dbg !15
    ...
    #dbg_declare(i32 %var_T_subtract.type_index, !23, !DIExpression(), !15)
  %var_T_subtract.type_index.fr = freeze i32 %var_T_subtract.type_index, !dbg !15
  %9 = icmp sgt i32 %var_T_subtract.type_index.fr, 63, !dbg !15
  br i1 %9, label %assert_end8, label %switch.early.test68, !dbg !15

switch.early.test68:                              ; preds = %assert_end6
  switch i32 %var_T_subtract.type_index.fr, label %assert_fail7 [
...
assert_end12:                                     ; preds = %assert_end10
  ...
  %sub.var_A.shape = load ptr, ptr %25, align 8, !dbg !15
    ...
    #dbg_declare(ptr %sub.var_A.shape, !27, !DIExpression(), !15)
  %26 = load i64, ptr %sub.var_A.shape, align 8, !dbg !15, !tbaa !30
...
assert_end20:                                     ; preds = %assert_end18
  ...
  %sub.var_T_subtract.strides = load ptr, ptr %44, align 8, !dbg !15
    ...
    #dbg_declare(ptr %sub.var_T_subtract.strides, !53, !DIExpression(), !15)
  %T_subtract = load ptr, ptr %var_T_subtract, align 8, !dbg !15
...
assert_end22:                                     ; preds = %assert_end20
  %.not72 = icmp eq ptr %sub.var_A.strides, null, !dbg !15
  br i1 %.not72, label %if_end, label %if_then, !dbg !15, !prof !20

if_then:                                          ; preds = %assert_end22
  %57 = load i64, ptr %sub.var_A.strides, align 8, !dbg !15, !tbaa !55
...
assert_end32:                                     ; preds = %assert_end30
  %95 = load i64, ptr %sub.var_B.shape, align 8, !dbg !15, !tbaa !67
...
assert_end36:                                     ; preds = %assert_end34
  %.not73 = icmp eq ptr %sub.var_B.strides, null, !dbg !15
  br i1 %.not73, label %if_end38, label %if_then37, !dbg !15, !prof !20

if_then37:                                        ; preds = %assert_end36
  %104 = load i64, ptr %sub.var_B.strides, align 8, !dbg !15, !tbaa !79
...
assert_end50:                                     ; preds = %assert_end48
  %144 = load i64, ptr %sub.var_T_subtract.shape, align 8, !dbg !15, !tbaa !91
...
assert_end54:                                     ; preds = %assert_end52
  %.not74 = icmp eq ptr %sub.var_T_subtract.strides, null, !dbg !15
  br i1 %.not74, label %if_end56, label %if_then55, !dbg !15, !prof !20

if_then55:                                        ; preds = %assert_end54
  %153 = load i64, ptr %sub.var_T_subtract.strides, align 8, !dbg !15, !tbaa !103
...
assert_end64:                                     ; preds = %assert_end62
  %178 = icmp ne ptr %T_subtract, null, !dbg !15
...
assert_end66:                                     ; preds = %assert_end64
  tail call fastcc void @sub_compute_(i32 %M, i32 %N, ptr %T_subtract, ptr %A, ptr %B), !dbg !15
  br label %common.ret, !dbg !15
}
...
define internal fastcc void @sub_compute_(i32 %M, i32 %N, ptr noalias nocapture writeonly align 64 %T_subtract, ptr noalias nocapture readonly align 64 %A, ptr noalias nocapture readonly align 64 %B) unnamed_addr #2 !dbg !115 {
entry:
    #dbg_value(i32 %M, !119, !DIExpression(), !124)
    #dbg_value(i32 %N, !120, !DIExpression(), !124)
    #dbg_value(ptr %T_subtract, !121, !DIExpression(), !124)
...
!5 = distinct !DISubprogram(name: "sub", scope: !1, file: !1, type: !6, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !10)
...
!23 = !DILocalVariable(name: "var_T_subtract.type_index", scope: !5, file: !1, type: !8)
!24 = !DILocalVariable(name: "var_A", scope: !5, file: !1, type: !9)
!25 = !DILocalVariable(name: "var_B", scope: !5, file: !1, type: !9)
!26 = !DILocalVariable(name: "var_T_subtract", scope: !5, file: !1, type: !9)
!27 = !DILocalVariable(name: "sub.var_A.shape", scope: !5, file: !1, type: !28)
!28 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !29)
!29 = !DIBasicType(name: "int64", size: 64, encoding: DW_ATE_signed)
!30 = !{!31, !31, i64 0}
!31 = !{!"0x63a8dd1da2f0.w8.b0", !32, i64 0}
!32 = !{!"0x63a8dd1da2f0.w16.b0", !33, i64 0}
!33 = !{!"0x63a8dd1da2f0.w32.b0", !34, i64 0}
!34 = !{!"0x63a8dd1da2f0.w64.b0", !35, i64 0}
!35 = !{!"0x63a8dd1da2f0.w128.b0", !36, i64 0}
!36 = !{!"0x63a8dd1da2f0.w256.b0", !37, i64 0}
!37 = !{!"0x63a8dd1da2f0.w512.b0", !38, i64 0}
!38 = !{!"0x63a8dd1da2f0.w1024.b0", !39, i64 0}
!39 = !{!"0x63a8dd1da2f0", !19, i64 0}
!40 = !DILocalVariable(name: "M", scope: !5, file: !1, type: !8)
!41 = !{!42, !42, i64 0}
!42 = !{!"0x63a8dd1da2f0.w8.b8", !32, i64 0}
...
!49 = !DILocalVariable(name: "sub.var_B.shape", scope: !5, file: !1, type: !28)
!50 = !DILocalVariable(name: "sub.var_B.strides", scope: !5, file: !1, type: !28)
!51 = !DILocalVariable(name: "B", scope: !5, file: !1, type: !47)
!52 = !DILocalVariable(name: "sub.var_T_subtract.shape", scope: !5, file: !1, type: !28)
...
!55 = !{!56, !56, i64 0}
!56 = !{!"0x63a8dd1074d0.w8.b0", !57, i64 0}
!57 = !{!"0x63a8dd1074d0.w16.b0", !58, i64 0}
!58 = !{!"0x63a8dd1074d0.w32.b0", !59, i64 0}
!59 = !{!"0x63a8dd1074d0.w64.b0", !60, i64 0}
!60 = !{!"0x63a8dd1074d0.w128.b0", !61, i64 0}
!61 = !{!"0x63a8dd1074d0.w256.b0", !62, i64 0}
!62 = !{!"0x63a8dd1074d0.w512.b0", !63, i64 0}
!63 = !{!"0x63a8dd1074d0.w1024.b0", !64, i64 0}
!64 = !{!"0x63a8dd1074d0", !19, i64 0}
!65 = !{!66, !66, i64 0}
!66 = !{!"0x63a8dd1074d0.w8.b8", !57, i64 0}
!67 = !{!68, !68, i64 0}
!68 = !{!"0x63a8dd1286a0.w8.b0", !69, i64 0}
!69 = !{!"0x63a8dd1286a0.w16.b0", !70, i64 0}
!70 = !{!"0x63a8dd1286a0.w32.b0", !71, i64 0}
!71 = !{!"0x63a8dd1286a0.w64.b0", !72, i64 0}
!72 = !{!"0x63a8dd1286a0.w128.b0", !73, i64 0}
!73 = !{!"0x63a8dd1286a0.w256.b0", !74, i64 0}
!74 = !{!"0x63a8dd1286a0.w512.b0", !75, i64 0}
!75 = !{!"0x63a8dd1286a0.w1024.b0", !76, i64 0}
!76 = !{!"0x63a8dd1286a0", !19, i64 0}
!77 = !{!78, !78, i64 0}
!78 = !{!"0x63a8dd1286a0.w8.b8", !69, i64 0}
!79 = !{!80, !80, i64 0}
!80 = !{!"0x63a8dd1b0680.w8.b0", !81, i64 0}
!81 = !{!"0x63a8dd1b0680.w16.b0", !82, i64 0}
!82 = !{!"0x63a8dd1b0680.w32.b0", !83, i64 0}
!83 = !{!"0x63a8dd1b0680.w64.b0", !84, i64 0}
!84 = !{!"0x63a8dd1b0680.w128.b0", !85, i64 0}
!85 = !{!"0x63a8dd1b0680.w256.b0", !86, i64 0}
!86 = !{!"0x63a8dd1b0680.w512.b0", !87, i64 0}
!87 = !{!"0x63a8dd1b0680.w1024.b0", !88, i64 0}
!88 = !{!"0x63a8dd1b0680", !19, i64 0}
!89 = !{!90, !90, i64 0}
!90 = !{!"0x63a8dd1b0680.w8.b8", !81, i64 0}
!91 = !{!92, !92, i64 0}
!92 = !{!"0x63a8dd1d90d0.w8.b0", !93, i64 0}
!93 = !{!"0x63a8dd1d90d0.w16.b0", !94, i64 0}
!94 = !{!"0x63a8dd1d90d0.w32.b0", !95, i64 0}
!95 = !{!"0x63a8dd1d90d0.w64.b0", !96, i64 0}
!96 = !{!"0x63a8dd1d90d0.w128.b0", !97, i64 0}
!97 = !{!"0x63a8dd1d90d0.w256.b0", !98, i64 0}
!98 = !{!"0x63a8dd1d90d0.w512.b0", !99, i64 0}
!99 = !{!"0x63a8dd1d90d0.w1024.b0", !100, i64 0}
!100 = !{!"0x63a8dd1d90d0", !19, i64 0}
!101 = !{!102, !102, i64 0}
!102 = !{!"0x63a8dd1d90d0.w8.b8", !93, i64 0}
!103 = !{!104, !104, i64 0}
!104 = !{!"0x63a8dd1d9190.w8.b0", !105, i64 0}
!105 = !{!"0x63a8dd1d9190.w16.b0", !106, i64 0}
!106 = !{!"0x63a8dd1d9190.w32.b0", !107, i64 0}
!107 = !{!"0x63a8dd1d9190.w64.b0", !108, i64 0}
!108 = !{!"0x63a8dd1d9190.w128.b0", !109, i64 0}
!109 = !{!"0x63a8dd1d9190.w256.b0", !110, i64 0}
!110 = !{!"0x63a8dd1d9190.w512.b0", !111, i64 0}
!111 = !{!"0x63a8dd1d9190.w1024.b0", !112, i64 0}
!112 = !{!"0x63a8dd1d9190", !19, i64 0}
!113 = !{!114, !114, i64 0}
!114 = !{!"0x63a8dd1d9190.w8.b8", !105, i64 0}
...
!121 = !DILocalVariable(name: "T_subtract", arg: 3, scope: !115, file: !1, type: !47)
...
!129 = !{!130, !130, i64 0}
!130 = !{!"0x63a8dd18a6f0", !19, i64 0}
!131 = !{!132, !132, i64 0}
!132 = !{!"0x63a8dd1b5be0", !19, i64 0}
!133 = !{!134, !134, i64 0}
!134 = !{!"0x63a8dd223b40", !19, i64 0}
