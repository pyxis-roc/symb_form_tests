...
@.str = private constant [56 x i8] c"Assert fail: num_args == 2, shape: num_args should be 2\00", align 1
@.str.1 = private constant [13 x i8] c"RuntimeError\00", align 1
@.str.2 = private constant [64 x i8] c"Assert fail: not T.isnullptr(args), shape: args pointer is NULL\00", align 1
@.str.3 = private constant [147 x i8] c"Assert fail: var_A_type_index == 0 or var_A_type_index == 4 or var_A_type_index == 7 or var_A_type_index >= 64, shape: Expect arg[0] to be pointer\00", align 1
@.str.4 = private constant [171 x i8] c"Assert fail: var_T_shape_type_index == 0 or var_T_shape_type_index == 4 or var_T_shape_type_index == 7 or var_T_shape_type_index >= 64, shape: Expect arg[1] to be pointer\00", align 1
@.str.5 = private constant [96 x i8] c"Assert fail: not T.isnullptr(var_A), shape.var_A is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.6 = private constant [98 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_A, 0, 4, \22int32\22), shape.var_A.ndim is expected to equal 2\00", align 1
@.str.7 = private constant [108 x i8] c"Assert fail: not T.isnullptr(var_T_shape), shape.var_T_shape is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.8 = private constant [110 x i8] c"Assert fail: 1 == T.tvm_struct_get(var_T_shape, 0, 4, \22int32\22), shape.var_T_shape.ndim is expected to equal 1\00", align 1
@.str.9 = private constant [228 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_A, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_A, 0, 7, \22uint16\22) == T.uint16(1), shape.var_A.dtype is expected to be float32\00", align 1
@.str.10 = private constant [182 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, shape_var_A_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, shape_var_A_strides[0])), shape.var_A.strides: expected to be compact array\00", align 1
@.str.11 = private constant [188 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22), Argument shape.var_A.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22)\00", align 1
@.str.12 = private constant [168 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 10, \22int32\22) == 1, Argument shape.var_A.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_A, 0, 10, \22int32\22)\00", align 1
@.str.13 = private constant [101 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(A), shape.var_A is expected to have non-NULL data pointer\00", align 1
@.str.14 = private constant [250 x i8] c"Assert fail: T.tvm_struct_get(var_T_shape, 0, 5, \22uint8\22) == T.uint8(0) and T.tvm_struct_get(var_T_shape, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_T_shape, 0, 7, \22uint16\22) == T.uint16(1), shape.var_T_shape.dtype is expected to be int32\00", align 1
@.str.15 = private constant [179 x i8] c"Assert fail: T.Cast(\22int32\22, shape_var_T_shape_shape[0]) == 2, Argument shape.var_T_shape.shape[0] has an unsatisfied constraint: 2 == T.Cast(\22int32\22, shape_var_T_shape_shape[0])\00", align 1
@.str.16 = private constant [121 x i8] c"Assert fail: 1 == T.Cast(\22int32\22, shape_var_T_shape_strides[0]), shape.var_T_shape.strides: expected to be compact array\00", align 1
@.str.17 = private constant [206 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_T_shape, 0, 8, \22uint64\22), Argument shape.var_T_shape.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_T_shape, 0, 8, \22uint64\22)\00", align 1
@.str.18 = private constant [186 x i8] c"Assert fail: T.tvm_struct_get(var_T_shape, 0, 10, \22int32\22) == 1, Argument shape.var_T_shape.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_T_shape, 0, 10, \22int32\22)\00", align 1
@.str.19 = private constant [192 x i8] c"Assert fail: dev_id == T.tvm_struct_get(var_T_shape, 0, 9, \22int32\22), Argument shape.var_T_shape.device_id has an unsatisfied constraint: dev_id == T.tvm_struct_get(var_T_shape, 0, 9, \22int32\22)\00", align 1
@.str.20 = private constant [99 x i8] c"Assert fail: not T.isnullptr(T_shape), shape.var_T_shape is expected to have non-NULL data pointer\00", align 1
@__tvm_main__ = weak dllexport local_unnamed_addr constant [6 x i8] c"shape\00", align 1
@llvm.global_ctors = appending global [0 x { i32, ptr, ptr }] zeroinitializer

define dllexport range(i32 -1, 1) i32 @shape(ptr noalias nocapture readnone %self_handle, ptr noalias readonly %args, i32 %num_args, ptr noalias nocapture readnone %result) local_unnamed_addr #0 !dbg !5 {
entry:
...
assert_end4:                                      ; preds = %switch.early.test, %switch.early.test, %switch.early.test, %assert_end2
  ...
  %var_T_shape.type_index = load i32, ptr %5, align 4, !dbg !15
    #dbg_declare(i32 %var_T_shape.type_index, !22, !DIExpression(), !15)
    #dbg_declare(i32 %var_T_shape.type_index, !22, !DIExpression(), !15)
  %var_T_shape.type_index.fr = freeze i32 %var_T_shape.type_index, !dbg !15
  %6 = icmp sgt i32 %var_T_shape.type_index.fr, 63, !dbg !15
  br i1 %6, label %assert_end6, label %switch.early.test41, !dbg !15

switch.early.test41:                              ; preds = %assert_end4
  switch i32 %var_T_shape.type_index.fr, label %assert_fail5 [
...
assert_end6:                                      ; preds = %switch.early.test41, %switch.early.test41, %switch.early.test41, %assert_end4
  ...
  %13 = icmp eq i32 %var_T_shape.type_index.fr, 72, !dbg !15
  %var_T_shape.idx = select i1 %13, i64 16, i64 0, !dbg !15
  %var_T_shape = getelementptr inbounds nuw i8, ptr %12, i64 %var_T_shape.idx, !dbg !15
    #dbg_declare(ptr %var_T_shape, !24, !DIExpression(), !15)
    #dbg_declare(ptr %var_T_shape, !24, !DIExpression(), !15)
...
assert_end10:                                     ; preds = %assert_end8
  ...
  %shape.var_A.shape = load ptr, ptr %19, align 8, !dbg !15
    #dbg_declare(ptr %shape.var_A.shape, !25, !DIExpression(), !15)
    #dbg_declare(ptr %shape.var_A.shape, !25, !DIExpression(), !15)
  %20 = load i64, ptr %shape.var_A.shape, align 8, !dbg !15, !tbaa !28
  %M = trunc i64 %20 to i32, !dbg !15
    #dbg_declare(i32 %M, !38, !DIExpression(), !15)
    #dbg_declare(i32 %M, !38, !DIExpression(), !15)
  %21 = getelementptr inbounds nuw i8, ptr %shape.var_A.shape, i64 8, !dbg !15
  ...
  %shape.var_A.strides = load ptr, ptr %23, align 8, !dbg !15
    #dbg_declare(ptr %shape.var_A.strides, !42, !DIExpression(), !15)
    #dbg_declare(ptr %shape.var_A.strides, !42, !DIExpression(), !15)
...
assert_end12:                                     ; preds = %assert_end10
  %26 = getelementptr inbounds nuw i8, ptr %var_T_shape, i64 16, !dbg !15
...
assert_end14:                                     ; preds = %assert_end12
  %30 = getelementptr inbounds nuw i8, ptr %var_T_shape, i64 24, !dbg !15
  %shape.var_T_shape.shape = load ptr, ptr %30, align 8, !dbg !15
    #dbg_declare(ptr %shape.var_T_shape.shape, !47, !DIExpression(), !15)
    #dbg_declare(ptr %shape.var_T_shape.shape, !47, !DIExpression(), !15)
  %31 = getelementptr inbounds nuw i8, ptr %var_T_shape, i64 32, !dbg !15
  %shape.var_T_shape.strides = load ptr, ptr %31, align 8, !dbg !15
    #dbg_declare(ptr %shape.var_T_shape.strides, !48, !DIExpression(), !15)
    #dbg_declare(ptr %shape.var_T_shape.strides, !48, !DIExpression(), !15)
  %T_shape = load ptr, ptr %var_T_shape, align 8, !dbg !15
    #dbg_declare(ptr %T_shape, !49, !DIExpression(), !15)
    #dbg_declare(ptr %T_shape, !49, !DIExpression(), !15)
  call void @llvm.assume(i1 true) [ "align"(ptr %T_shape, i64 64) ], !dbg !15
...
assert_end24:                                     ; preds = %assert_end22
  %70 = getelementptr inbounds nuw i8, ptr %var_T_shape, i64 22, !dbg !15
  %71 = load i16, ptr %70, align 2, !dbg !15
  %72 = icmp eq i16 %71, 1, !dbg !15
  %73 = getelementptr inbounds nuw i8, ptr %var_T_shape, i64 21, !dbg !15
  %74 = load i8, ptr %73, align 1, !dbg !15
  %75 = icmp eq i8 %74, 32, !dbg !15
  %76 = getelementptr inbounds nuw i8, ptr %var_T_shape, i64 20, !dbg !15
...
assert_end26:                                     ; preds = %assert_end24
  %82 = load i64, ptr %shape.var_T_shape.shape, align 8, !dbg !15, !tbaa !63
  %83 = and i64 %82, 4294967295, !dbg !15
  %84 = icmp eq i64 %83, 2, !dbg !15
...
assert_end28:                                     ; preds = %assert_end26
  %.not45 = icmp eq ptr %shape.var_T_shape.strides, null, !dbg !15
  br i1 %.not45, label %if_end30, label %if_then29, !dbg !15, !prof !20

if_then29:                                        ; preds = %assert_end28
  %86 = load i64, ptr %shape.var_T_shape.strides, align 8, !dbg !15, !tbaa !73
  %87 = and i64 %86, 4294967295, !dbg !15
  %88 = icmp eq i64 %87, 1, !dbg !15
  br i1 %88, label %if_end30, label %assert_fail31, !dbg !15, !prof !16

if_end30:                                         ; preds = %if_then29, %assert_end28
  %89 = getelementptr inbounds nuw i8, ptr %var_T_shape, i64 40, !dbg !15
  %90 = load i64, ptr %89, align 8, !dbg !15
  %91 = icmp eq i64 %90, 0, !dbg !15
  br i1 %91, label %assert_end34, label %assert_fail33, !dbg !15, !prof !16
...
assert_fail33:                                    ; preds = %if_end30
  %93 = load ptr, ptr @__TVMFFIErrorSetRaisedFromCStr, align 8, !dbg !15, !tbaa !17
  tail call void %93(ptr nonnull @.str.1, ptr nonnull @.str.17), !dbg !15
  br label %common.ret, !dbg !15

assert_end34:                                     ; preds = %if_end30
  %94 = getelementptr inbounds nuw i8, ptr %var_T_shape, i64 8, !dbg !15
  %95 = load i32, ptr %94, align 4, !dbg !15
  %96 = icmp eq i32 %95, 1, !dbg !15
  br i1 %96, label %assert_end36, label %assert_fail35, !dbg !15, !prof !16

assert_fail35:                                    ; preds = %assert_end34
  %97 = load ptr, ptr @__TVMFFIErrorSetRaisedFromCStr, align 8, !dbg !15, !tbaa !17
  tail call void %97(ptr nonnull @.str.1, ptr nonnull @.str.18), !dbg !15
  br label %common.ret, !dbg !15

assert_end36:                                     ; preds = %assert_end34
  %98 = getelementptr inbounds nuw i8, ptr %var_T_shape, i64 12, !dbg !15
  %99 = load i32, ptr %98, align 4, !dbg !15
  %100 = icmp eq i32 %dev_id, %99, !dbg !15
  br i1 %100, label %assert_end38, label %assert_fail37, !dbg !15, !prof !16

assert_fail37:                                    ; preds = %assert_end36
  %101 = load ptr, ptr @__TVMFFIErrorSetRaisedFromCStr, align 8, !dbg !15, !tbaa !17
  tail call void %101(ptr nonnull @.str.1, ptr nonnull @.str.19), !dbg !15
  br label %common.ret, !dbg !15

assert_end38:                                     ; preds = %assert_end36
  %.not46 = icmp eq ptr %T_shape, null, !dbg !15
  br i1 %.not46, label %assert_fail39, label %assert_end40, !dbg !15, !prof !20

assert_fail39:                                    ; preds = %assert_end38
  %102 = load ptr, ptr @__TVMFFIErrorSetRaisedFromCStr, align 8, !dbg !15, !tbaa !17
  tail call void %102(ptr nonnull @.str.1, ptr nonnull @.str.20), !dbg !15
  br label %common.ret, !dbg !15

assert_end40:                                     ; preds = %assert_end38
  tail call fastcc void @shape_compute_(ptr nonnull %T_shape, i32 %N, i32 %M), !dbg !15
  br label %common.ret, !dbg !15
}
...
define internal fastcc void @shape_compute_(ptr noalias nocapture writeonly align 64 initializes((0, 8)) %T_shape, i32 %N, i32 %M) unnamed_addr #2 !dbg !83 {
entry:
    #dbg_value(ptr %T_shape, !87, !DIExpression(), !90)
    #dbg_value(i32 %N, !88, !DIExpression(), !90)
    #dbg_value(i32 %M, !89, !DIExpression(), !90)
    #dbg_declare(i32 0, !91, !DIExpression(), !90)
    #dbg_declare(i64 0, !91, !DIExpression(), !90)
  store i32 %M, ptr %T_shape, align 64, !dbg !90, !tbaa !92
    #dbg_declare(i64 1, !91, !DIExpression(), !90)
    #dbg_declare(i64 1, !91, !DIExpression(), !90)
  %0 = getelementptr inbounds nuw i8, ptr %T_shape, i64 4, !dbg !90
  store i32 %N, ptr %0, align 4, !dbg !90, !tbaa !92
    #dbg_declare(i64 2, !91, !DIExpression(), !90)
  ret void, !dbg !90
}
...
attributes #2 = { mustprogress nofree noinline norecurse nosync nounwind willreturn memory(argmem: write) "target-cpu"="generic" }
...
!5 = distinct !DISubprogram(name: "shape", scope: !1, file: !1, type: !6, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !10)
...
!22 = !DILocalVariable(name: "var_T_shape.type_index", scope: !5, file: !1, type: !8)
!23 = !DILocalVariable(name: "var_A", scope: !5, file: !1, type: !9)
!24 = !DILocalVariable(name: "var_T_shape", scope: !5, file: !1, type: !9)
!25 = !DILocalVariable(name: "shape.var_A.shape", scope: !5, file: !1, type: !26)
!26 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !27)
!27 = !DIBasicType(name: "int64", size: 64, encoding: DW_ATE_signed)
!28 = !{!29, !29, i64 0}
!29 = !{!"0x63a8dd1a0310.w8.b0", !30, i64 0}
!30 = !{!"0x63a8dd1a0310.w16.b0", !31, i64 0}
!31 = !{!"0x63a8dd1a0310.w32.b0", !32, i64 0}
!32 = !{!"0x63a8dd1a0310.w64.b0", !33, i64 0}
!33 = !{!"0x63a8dd1a0310.w128.b0", !34, i64 0}
!34 = !{!"0x63a8dd1a0310.w256.b0", !35, i64 0}
!35 = !{!"0x63a8dd1a0310.w512.b0", !36, i64 0}
!36 = !{!"0x63a8dd1a0310.w1024.b0", !37, i64 0}
!37 = !{!"0x63a8dd1a0310", !19, i64 0}
!38 = !DILocalVariable(name: "M", scope: !5, file: !1, type: !8)
!39 = !{!40, !40, i64 0}
!40 = !{!"0x63a8dd1a0310.w8.b8", !30, i64 0}
!41 = !DILocalVariable(name: "N", scope: !5, file: !1, type: !8)
!42 = !DILocalVariable(name: "shape.var_A.strides", scope: !5, file: !1, type: !26)
...
!47 = !DILocalVariable(name: "shape.var_T_shape.shape", scope: !5, file: !1, type: !26)
!48 = !DILocalVariable(name: "shape.var_T_shape.strides", scope: !5, file: !1, type: !26)
!49 = !DILocalVariable(name: "T_shape", scope: !5, file: !1, type: !50)
!50 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !8)
!51 = !{!52, !52, i64 0}
!52 = !{!"0x63a8dd13b0d0.w8.b0", !53, i64 0}
!53 = !{!"0x63a8dd13b0d0.w16.b0", !54, i64 0}
!54 = !{!"0x63a8dd13b0d0.w32.b0", !55, i64 0}
!55 = !{!"0x63a8dd13b0d0.w64.b0", !56, i64 0}
!56 = !{!"0x63a8dd13b0d0.w128.b0", !57, i64 0}
!57 = !{!"0x63a8dd13b0d0.w256.b0", !58, i64 0}
!58 = !{!"0x63a8dd13b0d0.w512.b0", !59, i64 0}
!59 = !{!"0x63a8dd13b0d0.w1024.b0", !60, i64 0}
!60 = !{!"0x63a8dd13b0d0", !19, i64 0}
!61 = !{!62, !62, i64 0}
!62 = !{!"0x63a8dd13b0d0.w8.b8", !53, i64 0}
!63 = !{!64, !64, i64 0}
!64 = !{!"0x63a8dcef7f70.w8.b0", !65, i64 0}
!65 = !{!"0x63a8dcef7f70.w16.b0", !66, i64 0}
!66 = !{!"0x63a8dcef7f70.w32.b0", !67, i64 0}
!67 = !{!"0x63a8dcef7f70.w64.b0", !68, i64 0}
!68 = !{!"0x63a8dcef7f70.w128.b0", !69, i64 0}
!69 = !{!"0x63a8dcef7f70.w256.b0", !70, i64 0}
!70 = !{!"0x63a8dcef7f70.w512.b0", !71, i64 0}
!71 = !{!"0x63a8dcef7f70.w1024.b0", !72, i64 0}
!72 = !{!"0x63a8dcef7f70", !19, i64 0}
!73 = !{!74, !74, i64 0}
!74 = !{!"0x63a8dd13d3b0.w8.b0", !75, i64 0}
!75 = !{!"0x63a8dd13d3b0.w16.b0", !76, i64 0}
!76 = !{!"0x63a8dd13d3b0.w32.b0", !77, i64 0}
!77 = !{!"0x63a8dd13d3b0.w64.b0", !78, i64 0}
!78 = !{!"0x63a8dd13d3b0.w128.b0", !79, i64 0}
!79 = !{!"0x63a8dd13d3b0.w256.b0", !80, i64 0}
!80 = !{!"0x63a8dd13d3b0.w512.b0", !81, i64 0}
!81 = !{!"0x63a8dd13d3b0.w1024.b0", !82, i64 0}
!82 = !{!"0x63a8dd13d3b0", !19, i64 0}
!83 = distinct !DISubprogram(name: "shape_compute_", scope: !1, file: !1, type: !84, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !86)
!84 = !DISubroutineType(cc: DW_CC_nocall, types: !85)
!85 = !{!8, !50, !8, !8}
!86 = !{!87, !88, !89}
!87 = !DILocalVariable(name: "T_shape", arg: 1, scope: !83, file: !1, type: !50)
!88 = !DILocalVariable(name: "N", arg: 2, scope: !83, file: !1, type: !8)
!89 = !DILocalVariable(name: "M", arg: 3, scope: !83, file: !1, type: !8)
!90 = !DILocation(line: 0, scope: !83)
!91 = !DILocalVariable(name: "ax0", scope: !83, file: !1, type: !8)
!92 = !{!93, !93, i64 0}
!93 = !{!"0x63a8dce55f10", !19, i64 0}
