...
@.str = private constant [64 x i8] c"Assert fail: num_args == 2, reorder_input: num_args should be 2\00", align 1
@.str.1 = private constant [13 x i8] c"RuntimeError\00", align 1
@.str.2 = private constant [72 x i8] c"Assert fail: not T.isnullptr(args), reorder_input: args pointer is NULL\00", align 1
@.str.3 = private constant [155 x i8] c"Assert fail: var_A_type_index == 0 or var_A_type_index == 4 or var_A_type_index == 7 or var_A_type_index >= 64, reorder_input: Expect arg[0] to be pointer\00", align 1
@.str.4 = private constant [195 x i8] c"Assert fail: var_T_transpose_type_index == 0 or var_T_transpose_type_index == 4 or var_T_transpose_type_index == 7 or var_T_transpose_type_index >= 64, reorder_input: Expect arg[1] to be pointer\00", align 1
@.str.5 = private constant [104 x i8] c"Assert fail: not T.isnullptr(var_A), reorder_input.var_A is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.6 = private constant [106 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_A, 0, 4, \22int32\22), reorder_input.var_A.ndim is expected to equal 2\00", align 1
@.str.7 = private constant [124 x i8] c"Assert fail: not T.isnullptr(var_T_transpose), reorder_input.var_T_transpose is expected to have non-NULL DLTensor* pointer\00", align 1
@.str.8 = private constant [126 x i8] c"Assert fail: 2 == T.tvm_struct_get(var_T_transpose, 0, 4, \22int32\22), reorder_input.var_T_transpose.ndim is expected to equal 2\00", align 1
@.str.9 = private constant [236 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_A, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_A, 0, 7, \22uint16\22) == T.uint16(1), reorder_input.var_A.dtype is expected to be float32\00", align 1
@.str.10 = private constant [206 x i8] c"Assert fail: (N == 1 or 1 == T.Cast(\22int32\22, reorder_input_var_A_strides[1])) and (M == 1 or N == T.Cast(\22int32\22, reorder_input_var_A_strides[0])), reorder_input.var_A.strides: expected to be compact array\00", align 1
@.str.11 = private constant [196 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22), Argument reorder_input.var_A.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_A, 0, 8, \22uint64\22)\00", align 1
@.str.12 = private constant [176 x i8] c"Assert fail: T.tvm_struct_get(var_A, 0, 10, \22int32\22) == 1, Argument reorder_input.var_A.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_A, 0, 10, \22int32\22)\00", align 1
@.str.13 = private constant [109 x i8] c"Assert fail: M * N == 0 or not T.isnullptr(A), reorder_input.var_A is expected to have non-NULL data pointer\00", align 1
@.str.14 = private constant [276 x i8] c"Assert fail: T.tvm_struct_get(var_T_transpose, 0, 5, \22uint8\22) == T.uint8(2) and T.tvm_struct_get(var_T_transpose, 0, 6, \22uint8\22) == T.uint8(32) and T.tvm_struct_get(var_T_transpose, 0, 7, \22uint16\22) == T.uint16(1), reorder_input.var_T_transpose.dtype is expected to be float32\00", align 1
@.str.15 = private constant [215 x i8] c"Assert fail: N == T.Cast(\22int32\22, reorder_input_var_T_transpose_shape[0]), Argument reorder_input.var_T_transpose.shape[0] has an unsatisfied constraint: N == T.Cast(\22int32\22, reorder_input_var_T_transpose_shape[0])\00", align 1
@.str.16 = private constant [215 x i8] c"Assert fail: M == T.Cast(\22int32\22, reorder_input_var_T_transpose_shape[1]), Argument reorder_input.var_T_transpose.shape[1] has an unsatisfied constraint: M == T.Cast(\22int32\22, reorder_input_var_T_transpose_shape[1])\00", align 1
@.str.17 = private constant [236 x i8] c"Assert fail: (M == 1 or 1 == T.Cast(\22int32\22, reorder_input_var_T_transpose_strides[1])) and (N == 1 or M == T.Cast(\22int32\22, reorder_input_var_T_transpose_strides[0])), reorder_input.var_T_transpose.strides: expected to be compact array\00", align 1
@.str.18 = private constant [226 x i8] c"Assert fail: T.uint64(0) == T.tvm_struct_get(var_T_transpose, 0, 8, \22uint64\22), Argument reorder_input.var_T_transpose.byte_offset has an unsatisfied constraint: T.uint64(0) == T.tvm_struct_get(var_T_transpose, 0, 8, \22uint64\22)\00", align 1
@.str.19 = private constant [206 x i8] c"Assert fail: T.tvm_struct_get(var_T_transpose, 0, 10, \22int32\22) == 1, Argument reorder_input.var_T_transpose.device_type has an unsatisfied constraint: 1 == T.tvm_struct_get(var_T_transpose, 0, 10, \22int32\22)\00", align 1
@.str.20 = private constant [212 x i8] c"Assert fail: dev_id == T.tvm_struct_get(var_T_transpose, 0, 9, \22int32\22), Argument reorder_input.var_T_transpose.device_id has an unsatisfied constraint: dev_id == T.tvm_struct_get(var_T_transpose, 0, 9, \22int32\22)\00", align 1
@.str.21 = private constant [129 x i8] c"Assert fail: N * M == 0 or not T.isnullptr(T_transpose), reorder_input.var_T_transpose is expected to have non-NULL data pointer\00", align 1
@__tvm_main__ = weak dllexport local_unnamed_addr constant [14 x i8] c"reorder_input\00", align 1
@llvm.global_ctors = appending global [0 x { i32, ptr, ptr }] zeroinitializer

define dllexport range(i32 -1, 1) i32 @reorder_input(ptr noalias nocapture readnone %self_handle, ptr noalias readonly %args, i32 %num_args, ptr noalias nocapture readnone %result) local_unnamed_addr #0 !dbg !5 {
entry:
...
assert_end10:                                     ; preds = %assert_end8
  ...
  %reorder_input.var_A.shape = load ptr, ptr %19, align 8, !dbg !15
    #dbg_declare(ptr %reorder_input.var_A.shape, !25, !DIExpression(), !15)
    #dbg_declare(ptr %reorder_input.var_A.shape, !25, !DIExpression(), !15)
  %20 = load i64, ptr %reorder_input.var_A.shape, align 8, !dbg !15, !tbaa !28
  %M = trunc i64 %20 to i32, !dbg !15
    #dbg_declare(i32 %M, !38, !DIExpression(), !15)
    #dbg_declare(i32 %M, !38, !DIExpression(), !15)
  %21 = getelementptr inbounds i8, ptr %reorder_input.var_A.shape, i64 8, !dbg !15
  ...
  %reorder_input.var_A.strides = load ptr, ptr %23, align 8, !dbg !15
    #dbg_declare(ptr %reorder_input.var_A.strides, !42, !DIExpression(), !15)
    #dbg_declare(ptr %reorder_input.var_A.strides, !42, !DIExpression(), !15)
...
assert_end14:                                     ; preds = %assert_end12
  ...
  %reorder_input.var_T_transpose.shape = load ptr, ptr %30, align 8, !dbg !15
    #dbg_declare(ptr %reorder_input.var_T_transpose.shape, !47, !DIExpression(), !15)
    #dbg_declare(ptr %reorder_input.var_T_transpose.shape, !47, !DIExpression(), !15)
  %31 = getelementptr inbounds i8, ptr %var_T_transpose, i64 32, !dbg !15
  %reorder_input.var_T_transpose.strides = load ptr, ptr %31, align 8, !dbg !15
    #dbg_declare(ptr %reorder_input.var_T_transpose.strides, !48, !DIExpression(), !15)
    #dbg_declare(ptr %reorder_input.var_T_transpose.strides, !48, !DIExpression(), !15)
...
assert_end16:                                     ; preds = %assert_end14
  %.not46 = icmp eq ptr %reorder_input.var_A.strides, null, !dbg !15
  br i1 %.not46, label %if_end, label %if_then, !dbg !15, !prof !20

if_then:                                          ; preds = %assert_end16
  %44 = load i64, ptr %reorder_input.var_A.strides, align 8, !dbg !15, !tbaa !50
  %45 = trunc i64 %44 to i32, !dbg !15
  %46 = icmp eq i32 %N, %45, !dbg !15
  %47 = icmp eq i32 %M, 1, !dbg !15
  %48 = or i1 %47, %46, !dbg !15
  %49 = getelementptr inbounds i8, ptr %reorder_input.var_A.strides, i64 8, !dbg !15
...
assert_end26:                                     ; preds = %assert_end24
  %82 = load i64, ptr %reorder_input.var_T_transpose.shape, align 8, !dbg !15, !tbaa !62
...
assert_end28:                                     ; preds = %assert_end26
  %86 = getelementptr inbounds i8, ptr %reorder_input.var_T_transpose.shape, i64 8, !dbg !15
...
assert_end30:                                     ; preds = %assert_end28
  %.not47 = icmp eq ptr %reorder_input.var_T_transpose.strides, null, !dbg !15
  br i1 %.not47, label %if_end32, label %if_then31, !dbg !15, !prof !20

if_then31:                                        ; preds = %assert_end30
  %91 = load i64, ptr %reorder_input.var_T_transpose.strides, align 8, !dbg !15, !tbaa !74
  %92 = trunc i64 %91 to i32, !dbg !15
  %93 = icmp eq i32 %M, %92, !dbg !15
  %94 = icmp eq i32 %N, 1, !dbg !15
  %95 = or i1 %94, %93, !dbg !15
  %96 = getelementptr inbounds i8, ptr %reorder_input.var_T_transpose.strides, i64 8, !dbg !15
...
assert_end42:                                     ; preds = %assert_end40
  tail call fastcc void @reorder_input_compute_(i32 %N, i32 %M, ptr %T_transpose, ptr %A), !dbg !15
  br label %common.ret, !dbg !15
}
...
define internal fastcc void @reorder_input_compute_(i32 %N, i32 %M, ptr noalias nocapture writeonly align 64 %T_transpose, ptr noalias nocapture readonly align 64 %A) unnamed_addr #2 !dbg !86 {
entry:
...
!5 = distinct !DISubprogram(name: "reorder_input", scope: !1, file: !1, type: !6, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !10)
...
!25 = !DILocalVariable(name: "reorder_input.var_A.shape", scope: !5, file: !1, type: !26)
!26 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !27)
!27 = !DIBasicType(name: "int64", size: 64, encoding: DW_ATE_signed)
!28 = !{!29, !29, i64 0}
!29 = !{!"0x310aff60.w8.b0", !30, i64 0}
!30 = !{!"0x310aff60.w16.b0", !31, i64 0}
!31 = !{!"0x310aff60.w32.b0", !32, i64 0}
!32 = !{!"0x310aff60.w64.b0", !33, i64 0}
!33 = !{!"0x310aff60.w128.b0", !34, i64 0}
!34 = !{!"0x310aff60.w256.b0", !35, i64 0}
!35 = !{!"0x310aff60.w512.b0", !36, i64 0}
!36 = !{!"0x310aff60.w1024.b0", !37, i64 0}
!37 = !{!"0x310aff60", !19, i64 0}
!38 = !DILocalVariable(name: "M", scope: !5, file: !1, type: !8)
!39 = !{!40, !40, i64 0}
!40 = !{!"0x310aff60.w8.b8", !30, i64 0}
!41 = !DILocalVariable(name: "N", scope: !5, file: !1, type: !8)
!42 = !DILocalVariable(name: "reorder_input.var_A.strides", scope: !5, file: !1, type: !26)
...
!47 = !DILocalVariable(name: "reorder_input.var_T_transpose.shape", scope: !5, file: !1, type: !26)
!48 = !DILocalVariable(name: "reorder_input.var_T_transpose.strides", scope: !5, file: !1, type: !26)
!49 = !DILocalVariable(name: "T_transpose", scope: !5, file: !1, type: !45)
!50 = !{!51, !51, i64 0}
!51 = !{!"0x31071180.w8.b0", !52, i64 0}
!52 = !{!"0x31071180.w16.b0", !53, i64 0}
!53 = !{!"0x31071180.w32.b0", !54, i64 0}
!54 = !{!"0x31071180.w64.b0", !55, i64 0}
!55 = !{!"0x31071180.w128.b0", !56, i64 0}
!56 = !{!"0x31071180.w256.b0", !57, i64 0}
!57 = !{!"0x31071180.w512.b0", !58, i64 0}
!58 = !{!"0x31071180.w1024.b0", !59, i64 0}
!59 = !{!"0x31071180", !19, i64 0}
!60 = !{!61, !61, i64 0}
!61 = !{!"0x31071180.w8.b8", !52, i64 0}
!62 = !{!63, !63, i64 0}
!63 = !{!"0x310b6590.w8.b0", !64, i64 0}
!64 = !{!"0x310b6590.w16.b0", !65, i64 0}
!65 = !{!"0x310b6590.w32.b0", !66, i64 0}
!66 = !{!"0x310b6590.w64.b0", !67, i64 0}
!67 = !{!"0x310b6590.w128.b0", !68, i64 0}
!68 = !{!"0x310b6590.w256.b0", !69, i64 0}
!69 = !{!"0x310b6590.w512.b0", !70, i64 0}
!70 = !{!"0x310b6590.w1024.b0", !71, i64 0}
!71 = !{!"0x310b6590", !19, i64 0}
!72 = !{!73, !73, i64 0}
!73 = !{!"0x310b6590.w8.b8", !64, i64 0}
!74 = !{!75, !75, i64 0}
!75 = !{!"0x310ac540.w8.b0", !76, i64 0}
!76 = !{!"0x310ac540.w16.b0", !77, i64 0}
!77 = !{!"0x310ac540.w32.b0", !78, i64 0}
!78 = !{!"0x310ac540.w64.b0", !79, i64 0}
!79 = !{!"0x310ac540.w128.b0", !80, i64 0}
!80 = !{!"0x310ac540.w256.b0", !81, i64 0}
!81 = !{!"0x310ac540.w512.b0", !82, i64 0}
!82 = !{!"0x310ac540.w1024.b0", !83, i64 0}
!83 = !{!"0x310ac540", !19, i64 0}
!84 = !{!85, !85, i64 0}
!85 = !{!"0x310ac540.w8.b8", !76, i64 0}
!86 = distinct !DISubprogram(name: "reorder_input_compute_", scope: !1, file: !1, type: !87, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !89)
...
!98 = !{!99, !99, i64 0}
!99 = !{!"0x311790a0", !19, i64 0}
!100 = !{!101, !101, i64 0}
!101 = !{!"0x31015bd0", !19, i64 0}
